...
# %bb.0:                                # %.preheader18
	...
	leal	-1926607734(%r12,%rdx), %edx
	roll	$20, %edx
	addl	%ecx, %edx
	xorl	%edx, %eax
	addl	%ebp, %eax
	leal	-378558(%r15,%rax), %eax
	roll	$4, %eax
	addl	%edx, %eax
	movl	%edx, %edi
	xorl	%ecx, %edi
...
# %bb.0:
	...
	callq	br_dec32le
	cmpb	$0, 15(%rsp)
	cmovneq	24(%rsp), %r14          # 8-byte Folded Reload
	cmovel	8(%rbx), %eax
	movl	%eax, (%r14)
	leaq	12(%r15), %rdi
	movq	%rbp, %rsi
	...
	cmovneq	152(%rsp), %rcx         # 8-byte Folded Reload
	cmovel	40(%rbx), %eax
	movl	%eax, (%rcx)
	leaq	44(%r15), %rdi
	movq	%rbp, %rsi
	...
	cmovneq	168(%rsp), %rcx         # 8-byte Folded Reload
	cmovel	44(%rbx), %eax
	movl	%eax, (%rcx)
	leaq	48(%r15), %rdi
	movq	%rbp, %rsi
	...
	cmovneq	200(%rsp), %rcx         # 8-byte Folded Reload
	cmovel	52(%rbx), %eax
	movl	%eax, (%rcx)
	leaq	56(%r15), %rdi
	movq	%rbp, %rsi
