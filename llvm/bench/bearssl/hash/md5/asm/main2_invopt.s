...
# %bb.0:
	...
	movq	br_md5_IV(%rip), %rax
	movq	%rax, 80(%rdi)
	movq	br_md5_IV+8(%rip), %rax
	movq	%rax, 88(%rdi)
	movq	$0, 72(%rdi)
	retq
.Lfunc_end4:
...
.LBB6_3:
	...
	movq	$-3, %rax
	.p2align	4, 0x90
.LBB6_4:                                # %.prol.preheader.i
                                        # =>This Inner Loop Header: Depth=1
	movl	12(%rsp,%rax,4), %ecx
	movl	%ecx, 12(%rbx,%rax,4)
	testq	%rax, %rax
	je	.LBB6_6
# %bb.5:                                # %.prol.preheader.i..prol.preheader.i_crit_edge
                                        #   in Loop: Header=BB6_4 Depth=1
	incq	%rax
	jmp	.LBB6_4
.LBB6_6:                                # %br_range_enc32le.exit
	addq	$80, %rsp
	popq	%rbx
	popq	%r14
	popq	%r15
...
# %bb.0:
	movq	$-3, %rax
	.p2align	4, 0x90
.LBB7_1:                                # %.prol.preheader.i
                                        # =>This Inner Loop Header: Depth=1
	movl	92(%rdi,%rax,4), %ecx
	movl	%ecx, 12(%rdx,%rax,4)
	testq	%rax, %rax
	je	.LBB7_3
# %bb.2:                                # %.prol.preheader.i..prol.preheader.i_crit_edge
                                        #   in Loop: Header=BB7_1 Depth=1
	incq	%rax
	jmp	.LBB7_1
.LBB7_3:                                # %br_range_enc32le.exit
	movq	72(%rdi), %rax
	retq
.Lfunc_end7:
...
# %bb.0:                                # %.preheader18
	...
	addl	%ebp, %eax
	leal	-1926607734(%rsi,%rax), %eax
	roll	$20, %eax
	addl	%ecx, %eax
	xorl	%eax, %edi
	addl	%r9d, %edx
	leal	-378558(%rdi,%rdx), %esi
	roll	$4, %esi
	addl	%eax, %esi
	...
	xorl	%eax, %ecx
	addl	%ebx, %r8d
	leal	-2022574463(%rcx,%r8), %ecx
	roll	$11, %ecx
	addl	%esi, %ecx
	leal	(%r13,%rax), %edi
	xorl	%ecx, %eax
	xorl	%esi, %eax
	leal	1839030562(%rax,%rdx), %edx
	roll	$16, %edx
	addl	%ecx, %edx
	leal	(%r15,%rsi), %r8d
	xorl	%edx, %esi
	xorl	%ecx, %esi
	leal	-35309556(%rsi,%rdi), %eax
	roll	$23, %eax
	addl	%edx, %eax
	leal	(%r10,%rcx), %esi
	xorl	%eax, %ecx
	xorl	%edx, %ecx
	leal	-1530992060(%rcx,%r8), %ecx
	roll	$4, %ecx
	addl	%eax, %ecx
	leal	(%r14,%rdx), %edi
	xorl	%ecx, %edx
	xorl	%eax, %edx
	leal	1272893353(%rdx,%rsi), %edx
	roll	$11, %edx
	addl	%ecx, %edx
	...
	xorl	%edx, %eax
	xorl	%ecx, %eax
	leal	-155497632(%rax,%rdi), %eax
	roll	$16, %eax
	addl	%edx, %eax
	leal	(%r11,%rcx), %edi
	xorl	%eax, %ecx
	xorl	%edx, %ecx
	leal	-1094730640(%rcx,%rsi), %ecx
	roll	$23, %ecx
	addl	%eax, %ecx
	...
	xorl	%eax, %ecx
	xorl	%edx, %ecx
	leal	-421815835(%rcx,%rsi), %ecx
	roll	$11, %ecx
	addl	%eax, %ecx
	leal	(%r12,%rdx), %esi
	xorl	%ecx, %edx
	xorl	%eax, %edx
	leal	530742520(%rdx,%rdi), %edx
	roll	$16, %edx
	addl	%ecx, %edx
	movq	%r11, %rdi
	addl	%eax, %edi
...
.LBB10_8:                               # %.lr.ph.new
	...
	movl	8(%rdx,%rcx,4), %esi
	movl	%esi, 8(%rdi,%rcx,4)
	movl	12(%rdx,%rcx,4), %esi
	movl	%esi, 12(%rdi,%rcx,4)
	movl	16(%rdx,%rcx,4), %esi
	movl	%esi, 16(%rdi,%rcx,4)
	movl	20(%rdx,%rcx,4), %esi
	movl	%esi, 20(%rdi,%rcx,4)
	movl	24(%rdx,%rcx,4), %esi
	movl	%esi, 24(%rdi,%rcx,4)
	movl	28(%rdx,%rcx,4), %esi
	movl	%esi, 28(%rdi,%rcx,4)
	addq	$8, %rcx
	cmpq	%rcx, %rax
	jne	.LBB10_8
.LBB10_9:                               # %._crit_edge
	retq
.Lfunc_end10:
	.size	br_range_enc32le, .Lfunc_end10-br_range_enc32le
                                        # -- End function
...
# %bb.0:
	...
	cmovneq	%rdi, %rdx
	movq	%rdi, %rcx
	testb	$1, -124(%rsp)          # 1-byte Folded Reload
	movq	%rax, %rdi
	cmovneq	%r8, %rdi
	movl	(%rdi), %edi
	movl	%edi, (%rax)
	leaq	4(%r8), %rax
	cmoveq	-120(%rsp), %rax        # 8-byte Folded Reload
	movl	(%rax), %eax
	movl	%eax, (%rsi)
	leaq	8(%r8), %rax
	cmoveq	-112(%rsp), %rax        # 8-byte Folded Reload
	movl	(%rax), %eax
	movl	%eax, (%r9)
	leaq	12(%r8), %rax
	cmoveq	-104(%rsp), %rax        # 8-byte Folded Reload
	movl	(%rax), %eax
	movl	%eax, (%r11)
	leaq	16(%r8), %rax
	cmoveq	-96(%rsp), %rax         # 8-byte Folded Reload
	movl	(%rax), %eax
	movl	%eax, (%r10)
	leaq	20(%r8), %rax
	...
	movl	%eax, (%rbx)
	leaq	28(%r8), %rax
	cmoveq	-72(%rsp), %rax         # 8-byte Folded Reload
	movl	(%rax), %eax
	movl	%eax, (%r15)
	leaq	32(%r8), %rax
	...
	movl	%eax, (%r13)
	leaq	40(%r8), %rax
	cmoveq	-48(%rsp), %rax         # 8-byte Folded Reload
	movl	(%rax), %eax
	movl	%eax, (%rbp)
	leaq	44(%r8), %rax
	...
	movl	%eax, (%rsi)
	leaq	52(%r8), %rax
	cmoveq	-8(%rsp), %rax          # 8-byte Folded Reload
	movl	(%rax), %eax
	...
	retq
.Lfunc_end11:
	.size	br_range_dec32le, .Lfunc_end11-br_range_dec32le
                                        # -- End function
...
# %bb.19:                               #   in Loop: Header=BB12_6 Depth=2
	...
	testb	$1, %bpl
	je	.LBB12_10
# %bb.20:                               #   in Loop: Header=BB12_6 Depth=2
	movl	randombytes.fd(%rip), %edi
	movq	%r15, %rsi
	movq	%rbx, %rdx
	callq	read
...
# %bb.21:                               #   in Loop: Header=BB12_6 Depth=2
	...
	testb	$1, %bpl
	je	.LBB12_10
# %bb.22:                               #   in Loop: Header=BB12_6 Depth=2
	movl	randombytes.fd(%rip), %edi
	movq	%r15, %rsi
	movq	%rbx, %rdx
	callq	read
	testq	%rax, %rax
	jg	.LBB12_9
# %bb.23:                               #   in Loop: Header=BB12_6 Depth=2
	movl	$1, %edi
	callq	sleep
	testb	$1, %bpl
	jne	.LBB12_6
...
.LBB12_31:
	...
	callq	__assert_fail
.Lfunc_end12:
	.size	randombytes, .Lfunc_end12-randombytes
	.cfi_endproc
                                        # -- End function
...
# %bb.1:                                # %SP_return
	...
	.cfi_def_cfa %rsp, 8
	retq
.LBB13_2:                               # %CallStackCheckFailBlk
	.cfi_def_cfa %rbp, 16
	callq	__stack_chk_fail
.Lfunc_end13:
	.size	randombit, .Lfunc_end13-randombit
	.cfi_endproc
                                        # -- End function
