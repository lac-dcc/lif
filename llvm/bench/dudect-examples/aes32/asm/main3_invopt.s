...
# %bb.0:                                # %.preheader12
	...
	setg	-121(%rsp)              # 1-byte Folded Spill
	cmpl	$10, %esi
	leaq	188(%r15), %rdx
	...
	setg	-122(%rsp)              # 1-byte Folded Spill
	xorl	(%r15), %ebx
	movl	%ebx, %eax
	shrl	$24, %eax
	movl	$-966564955, %edx       # imm = 0xC66363A5
	cmovnel	Te0(,%rax,4), %edx
	movl	4(%rcx), %eax
	bswapl	%eax
	movl	%eax, %edi
	movl	8(%rcx), %r14d
	...
	movzbl	%cl, %ecx
	testl	%ecx, %ecx
	movl	$-1513725085, %esi      # imm = 0xA5C66363
	cmovnel	Te1(,%rcx,4), %esi
	movl	%r14d, %ecx
	movzbl	%ch, %ecx
	testl	%ecx, %ecx
	movl	$1671808611, %ebp       # imm = 0x63A5C663
	cmovnel	Te2(,%rcx,4), %ebp
	xorl	%edx, %ebp
	movzbl	%al, %ecx
	testl	%ecx, %ecx
	movl	$1667474886, %edx       # imm = 0x6363A5C6
	cmovnel	Te3(,%rcx,4), %edx
	movzbl	%bl, %ecx
	...
	cmovgq	8(%rsp), %rcx           # 8-byte Folded Reload
	movl	%edi, %esi
	...
	cmovgq	24(%rsp), %rcx          # 8-byte Folded Reload
	movl	%edx, %esi
	shrl	$24, %esi
	movl	%ebx, %ebp
	shrl	$16, %ebp
	...
	cmovgq	40(%rsp), %rdi          # 8-byte Folded Reload
	movl	%r10d, %esi
	shrl	$24, %esi
	movl	%r9d, %ecx
	shrl	$16, %ecx
	...
	cmovgq	-88(%rsp), %rbp         # 8-byte Folded Reload
	movl	%r9d, %ecx
	shrl	$24, %ecx
	movl	%eax, %esi
	shrl	$16, %esi
	...
	cmovgq	-80(%rsp), %rdx         # 8-byte Folded Reload
	movl	%eax, %ecx
	shrl	$24, %ecx
	movl	%ebx, %esi
	shrl	$16, %esi
	...
	cmovgq	72(%rsp), %rsi          # 8-byte Folded Reload
	movl	%r10d, %ecx
	shrl	$16, %ecx
	movzbl	%cl, %ecx
	shrl	$24, %ebx
	...
	cmovgq	-72(%rsp), %rdx         # 8-byte Folded Reload
	movl	%r8d, %ebp
	movl	%r8d, %eax
	shrl	$24, %eax
	movl	%edi, %ecx
	...
	cmovgq	96(%rsp), %rsi          # 8-byte Folded Reload
	movl	%edi, %edx
	movl	%edi, %r8d
	shrl	$24, %edx
	movl	%ebx, %eax
	...
	cmovgq	-56(%rsp), %rdx         # 8-byte Folded Reload
	xorl	(%rdx), %eax
	movl	%eax, %r11d
	movzbl	%al, %edx
	movq	%rdx, -56(%rsp)         # 8-byte Spill
	...
	cmovgq	128(%rsp), %r12         # 8-byte Folded Reload
	movl	%r9d, %ecx
	movl	%r9d, %esi
	shrl	$24, %esi
	shrl	$16, %edi
	...
	cmovgq	144(%rsp), %rdi         # 8-byte Folded Reload
	shrl	$24, %r11d
	shrl	$16, %ebx
	movzbl	%bl, %edx
	movl	Te1(,%rdx,4), %edx
	...
	cmovgq	160(%rsp), %rdi         # 8-byte Folded Reload
	shrl	$24, %r14d
	movl	%eax, %esi
	shrl	$16, %esi
	movzbl	%sil, %esi
	...
	cmovgq	176(%rsp), %rsi         # 8-byte Folded Reload
	shrl	$16, %ecx
	movzbl	%cl, %ecx
	shrl	$24, %eax
	movl	Te1(,%rcx,4), %ecx
	...
	xorl	(%rax), %ecx
	movb	-122(%rsp), %al         # 1-byte Reload
	xorb	-121(%rsp), %al         # 1-byte Folded Reload
	cmovnel	-88(%rsp), %r9d         # 4-byte Folded Reload
	cmovnel	-80(%rsp), %edx         # 4-byte Folded Reload
	cmovnel	%ebp, %ebx
	cmovnel	-72(%rsp), %ecx         # 4-byte Folded Reload
	movl	-28(%rsp), %esi         # 4-byte Reload
	cmpl	$10, %esi
	cmovlel	-112(%rsp), %r9d        # 4-byte Folded Reload
	cmovlel	-120(%rsp), %edx        # 4-byte Folded Reload
	cmovlel	-96(%rsp), %ebx         # 4-byte Folded Reload
	cmovlel	-104(%rsp), %ecx        # 4-byte Folded Reload
	movl	%edx, %eax
	movq	%rax, -120(%rsp)        # 8-byte Spill
	movzbl	%dl, %eax
	movq	%rax, -40(%rsp)         # 8-byte Spill
	...
	movl	%ecx, %edx
	shrl	$24, %ecx
	movzbl	Te4+3(,%rcx,4), %r13d
	movl	%esi, %ecx
	shll	$2, %ecx
	movslq	%ecx, %rsi
	movzbl	Te4(,%r14,4), %ebp
	orl	%eax, %ebp
	xorl	(%r15,%rsi,4), %ebp
	bswapl	%ebp
	...
	shll	$8, %edi
	orl	%ebx, %edi
	movzbl	Te4(,%r14,4), %ecx
	orl	%edi, %ecx
	xorl	4(%r15,%rsi,4), %ecx
	bswapl	%ecx
	movl	%ecx, 4(%r8)
	shrl	$24, %r12d
	movzbl	Te4+3(,%r12,4), %ecx
	shll	$24, %ecx
	shrl	$16, %edx
	movzbl	%dl, %edx
	movzbl	Te4+2(,%rdx,4), %edx
	...
	orl	%ebp, %ecx
	xorl	8(%r15,%rsi,4), %ecx
	bswapl	%ecx
	movl	%ecx, 8(%r8)
	shll	$24, %r13d
	movzbl	Te4+2(,%r11,4), %ecx
	shll	$16, %ecx
	orl	%r13d, %ecx
	shll	$8, %eax
	orl	%ecx, %eax
...
.LBB7_3:
	...
	shll	$8, %eax
	orl	%esi, %eax
	movzbl	Td4(,%r14,4), %esi
	orl	%eax, %esi
	xorl	4(%r12,%rdi,4), %esi
	bswapl	%esi
	movl	%esi, 4(%r13)
	shrl	$24, %ebp
	movzbl	Td4+3(,%rbp,4), %eax
	shll	$24, %eax
	shrl	$16, %r10d
	movzbl	%r10b, %esi
	movzbl	Td4+2(,%rsi,4), %esi
	shll	$16, %esi
	orl	%eax, %esi
	movzbl	Td4+1(,%rcx,4), %eax
	shll	$8, %eax
	orl	%esi, %eax
	movzbl	Td4(,%r8,4), %ecx
	orl	%eax, %ecx
	xorl	8(%r12,%rdi,4), %ecx
	bswapl	%ecx
	movl	%ecx, 8(%r13)
	shll	$24, %r15d
	movzbl	Td4+2(,%r11,4), %eax
	shll	$16, %eax
	orl	%r15d, %eax
	movzbl	Td4+1(,%rbx,4), %ecx
	shll	$8, %ecx
	orl	%eax, %ecx
	movzbl	Td4(,%r9,4), %eax
	orl	%ecx, %eax
	xorl	12(%r12,%rdi,4), %eax
	bswapl	%eax
	movl	%eax, 12(%r13)
	popq	%rbx
	popq	%r12
