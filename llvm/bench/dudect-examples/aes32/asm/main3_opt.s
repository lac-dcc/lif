...
# %bb.2:
	...
	jmp	.LBB3_3
.LBB3_1:
	movl	$-966564955, -56(%rbp)  # 4-byte Folded Spill
                                        # imm = 0xC66363A5
.LBB3_3:                                # %.preheader12
...
# %bb.8:
	...
	jmp	.LBB3_9
.LBB3_7:
	movl	$1671808611, %edx       # imm = 0x63A5C663
.LBB3_9:                                # %.preheader
	xorl	%edx, %esi
	movl	%eax, %edx
	andl	$255, %edx
...
# %bb.11:
	...
	jmp	.LBB3_12
.LBB3_10:
	movl	$1667474886, %r10d      # imm = 0x6363A5C6
.LBB3_12:
...
.LBB3_16:
	...
	movzbl	%bl, %r9d
	movzbl	%bh, %ebx
	movzbl	Te4+1(,%r12,4), %ecx
	shll	$8, %ecx
	orl	%edi, %ecx
	movzbl	Te4(,%r8,4), %edi
	orl	%ecx, %edi
	xorl	4(%rdx,%r15,4), %edi
	bswapl	%edi
	movl	%edi, 4(%r13)
	movl	%eax, %ecx
	shrl	$24, %ecx
	...
	shll	$16, %edi
	orl	%ecx, %edi
	movzbl	Te4+1(,%rsi,4), %ecx
	shll	$8, %ecx
	orl	%edi, %ecx
	movzbl	Te4(,%r9,4), %esi
	orl	%ecx, %esi
	xorl	8(%rdx,%r15,4), %esi
	movzbl	%al, %ecx
	bswapl	%esi
	movl	%esi, 8(%r13)
	shll	$24, %r14d
	movzbl	Te4+2(,%r11,4), %esi
	shll	$16, %esi
	orl	%r14d, %esi
	movzbl	Te4+1(,%rbx,4), %eax
	shll	$8, %eax
	orl	%esi, %eax
	movzbl	Te4(,%rcx,4), %ecx
	orl	%eax, %ecx
	xorl	12(%rdx,%r15,4), %ecx
	bswapl	%ecx
	movl	%ecx, 12(%r13)
	popq	%rbx
	popq	%r12
...
# %bb.1:                                # %.loopexit
	movzbl	%r11b, %ecx
	movzbl	Te4+3(,%r10,4), %edx
	shll	$24, %edx
	movzbl	Te4+2(,%rbx,4), %esi
	shll	$16, %esi
	...
	xorl	%eax, %r9d
	xorl	%ecx, %r9d
	xorl	$16777216, %r9d         # imm = 0x1000000
	movl	%r9d, 16(%rdi)
	xorl	%r9d, %r14d
	movl	%r14d, 20(%rdi)
	movl	%r14d, %eax
	...
	xorl	%r9d, %edx
	xorl	%ebx, %edx
	xorl	$452984832, %edx        # imm = 0x1B000000
	movl	%edx, 144(%rdi)
	xorl	%edx, %r14d
	movl	%r14d, 148(%rdi)
	movl	%r14d, %ecx
...
.LBB7_6:
	...
	movzbl	%al, %r9d
	shrl	$24, %eax
	movzbl	Td4+3(,%rax,4), %r10d
	movl	%ecx, %edi
	shrl	$24, %edi
	movzbl	Td4+3(,%rdi,4), %edi
	shll	$24, %edi
	shrl	$16, %ebx
	movzbl	%bl, %eax
	movzbl	Td4+2(,%rax,4), %ebx
	shll	$16, %ebx
	orl	%edi, %ebx
	movzbl	%dh, %edi
	movzbl	%dl, %r11d
	...
	movzbl	Td4+1(,%rdx,4), %esi
	shll	$8, %esi
	orl	%ebx, %esi
	movzbl	Td4(,%r11,4), %ebx
	orl	%esi, %ebx
	xorl	4(%r13,%r8,4), %ebx
	bswapl	%ebx
	movl	%ebx, 4(%r12)
