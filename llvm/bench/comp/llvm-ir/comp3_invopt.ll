; ModuleID = 'comp/llvm-ir/comp3.ll'
source_filename = "comp/sources/comp3.c"
...
define dso_local i32 @main() #0 !dbg !26 {
  ...
  call void @llvm.dbg.declare(metadata [4 x i32]* %1, metadata !29, metadata !DIExpression()), !dbg !33
  call void @llvm.dbg.declare(metadata [4 x i32]* %2, metadata !34, metadata !DIExpression()), !dbg !35
...
3:                                                ; preds = %0
  ...
  %4 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 0, !dbg !40
  store i32 0, i32* %4, align 4, !dbg !42
  %5 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 0, !dbg !43
  store i32 0, i32* %5, align 4, !dbg !44
  call void @llvm.dbg.value(metadata i64 1, metadata !36, metadata !DIExpression()), !dbg !38
  %6 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 1, !dbg !40
  store i32 1, i32* %6, align 4, !dbg !42
  %7 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 1, !dbg !43
  store i32 1, i32* %7, align 4, !dbg !44
  call void @llvm.dbg.value(metadata i64 2, metadata !36, metadata !DIExpression()), !dbg !38
  %8 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 2, !dbg !40
  store i32 2, i32* %8, align 4, !dbg !42
  %9 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 2, !dbg !43
  store i32 2, i32* %9, align 4, !dbg !44
  call void @llvm.dbg.value(metadata i64 3, metadata !36, metadata !DIExpression()), !dbg !38
  %10 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 3, !dbg !40
  store i32 3, i32* %10, align 4, !dbg !42
  %11 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 3, !dbg !43
  store i32 3, i32* %11, align 4, !dbg !44
  call void @llvm.dbg.value(metadata i64 4, metadata !36, metadata !DIExpression()), !dbg !38
  %12 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 3, !dbg !45
  store i32 -1, i32* %12, align 4, !dbg !46
  %13 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 0, !dbg !47
  %14 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 0, !dbg !48
  %15 = sext i32 4 to i64
  %16 = sext i32 4 to i64
  %17 = call i32 @comp(i32* %13, i64 %15, i32* %14, i64 %16), !dbg !49
  call void @llvm.dbg.value(metadata i32 %17, metadata !50, metadata !DIExpression()), !dbg !51
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %17), !dbg !52
  ret i32 0, !dbg !53
}
...
!1 = !DIFile(filename: "comp/sources/comp3.c", directory: "/home/luigi/dev/ufmg/static-analysis/side-channel/lif/llvm/bench")
!2 = !{}
...
!45 = !DILocation(line: 14, column: 5, scope: !26)
!46 = !DILocation(line: 14, column: 10, scope: !26)
!47 = !DILocation(line: 15, column: 18, scope: !26)
!48 = !DILocation(line: 15, column: 21, scope: !26)
!49 = !DILocation(line: 15, column: 13, scope: !26)
!50 = !DILocalVariable(name: "r", scope: !26, file: !1, line: 15, type: !12)
!51 = !DILocation(line: 0, scope: !26)
!52 = !DILocation(line: 16, column: 5, scope: !26)
!53 = !DILocation(line: 17, column: 5, scope: !26)
