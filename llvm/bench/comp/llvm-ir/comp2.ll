; ModuleID = 'comp/llvm-ir/comp2.ll'
source_filename = "comp/sources/comp2.c"
...
3:                                                ; preds = %0
  ...
  %68 = getelementptr inbounds [32 x i32], [32 x i32]* %2, i64 0, i64 0, !dbg !47
  store i32 -1, i32* %68, align 16, !dbg !48
  %69 = getelementptr inbounds [32 x i32], [32 x i32]* %1, i64 0, i64 0, !dbg !49
  %70 = getelementptr inbounds [32 x i32], [32 x i32]* %2, i64 0, i64 0, !dbg !50
  %71 = call i32 @comp(i32* %69, i32* %70), !dbg !51
  call void @llvm.dbg.value(metadata i32 %71, metadata !52, metadata !DIExpression()), !dbg !53
  %72 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %71), !dbg !54
  ret i32 0, !dbg !55
}
...
!1 = !DIFile(filename: "comp/sources/comp2.c", directory: "/home/luigi/dev/ufmg/static-analysis/side-channel/lif/llvm/bench")
!2 = !{}
