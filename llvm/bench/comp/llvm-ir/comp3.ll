...
define dso_local i32 @main() #0 !dbg !28 {
  ...
  call void @llvm.dbg.declare(metadata [4 x i32]* %1, metadata !31, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.declare(metadata [4 x i32]* %2, metadata !36, metadata !DIExpression()), !dbg !37
...
3:                                                ; preds = %0
  ...
  %4 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 0, !dbg !42
  store i32 0, i32* %4, align 4, !dbg !44
  %5 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 0, !dbg !45
  store i32 0, i32* %5, align 4, !dbg !46
  call void @llvm.dbg.value(metadata i64 1, metadata !38, metadata !DIExpression()), !dbg !40
  %6 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 1, !dbg !42
  store i32 1, i32* %6, align 4, !dbg !44
  %7 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 1, !dbg !45
  store i32 1, i32* %7, align 4, !dbg !46
  call void @llvm.dbg.value(metadata i64 2, metadata !38, metadata !DIExpression()), !dbg !40
  %8 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 2, !dbg !42
  store i32 2, i32* %8, align 4, !dbg !44
  %9 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 2, !dbg !45
  store i32 2, i32* %9, align 4, !dbg !46
  call void @llvm.dbg.value(metadata i64 3, metadata !38, metadata !DIExpression()), !dbg !40
  %10 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 3, !dbg !42
  store i32 3, i32* %10, align 4, !dbg !44
  %11 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 3, !dbg !45
  store i32 3, i32* %11, align 4, !dbg !46
  call void @llvm.dbg.value(metadata i64 4, metadata !38, metadata !DIExpression()), !dbg !40
  %12 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 3, !dbg !47
  store i32 -1, i32* %12, align 4, !dbg !48
  %13 = getelementptr inbounds [4 x i32], [4 x i32]* %1, i64 0, i64 0, !dbg !49
  %14 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 0, !dbg !50
  %15 = call i32 @comp(i32* %13, i32* %14), !dbg !51
  call void @llvm.dbg.value(metadata i32 %15, metadata !52, metadata !DIExpression()), !dbg !53
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %15), !dbg !54
  ret i32 0, !dbg !55
}
...
!32 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 128, elements: !33)
!33 = !{!34}
...
!48 = !DILocation(line: 14, column: 10, scope: !28)
!49 = !DILocation(line: 15, column: 18, scope: !28)
!50 = !DILocation(line: 15, column: 21, scope: !28)
!51 = !DILocation(line: 15, column: 13, scope: !28)
!52 = !DILocalVariable(name: "r", scope: !28, file: !1, line: 15, type: !12)
!53 = !DILocation(line: 0, scope: !28)
!54 = !DILocation(line: 16, column: 5, scope: !28)
!55 = !DILocation(line: 17, column: 5, scope: !28)
