...
define dso_local i32 @main() #0 !dbg !26 {
  ...
  %71 = call i32 @comp(i32* %67, i64 %69, i32* %68, i64 %70), !dbg !46
  call void @llvm.dbg.value(metadata i32 %71, metadata !47, metadata !DIExpression()), !dbg !48
  %72 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %71), !dbg !49
  ret i32 0, !dbg !50
}
