...
3:                                                ; preds = %0
  ...
  store i32 -1, i32* %68, align 16, !dbg !46
  %69 = getelementptr inbounds [32 x i32], [32 x i32]* %1, i64 0, i64 0, !dbg !47
  %70 = getelementptr inbounds [32 x i32], [32 x i32]* %2, i64 0, i64 0, !dbg !48
  %71 = sext i32 32 to i64
  %72 = sext i32 32 to i64
  %73 = call i32 @comp(i32* %69, i64 %71, i32* %70, i64 %72), !dbg !49
  call void @llvm.dbg.value(metadata i32 %73, metadata !50, metadata !DIExpression()), !dbg !51
  %74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %73), !dbg !52
  ret i32 0, !dbg !53
}
