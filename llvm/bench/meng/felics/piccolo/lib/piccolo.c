...
uint8_t SBOX[] __attribute__((aligned(64))) = {
    0x0e, 0x04, 0x0b, 0x02, 0x03, 0x08, 0x00, 0x09,
    0x01, 0x0a, 0x07, 0x0f, 0x06, 0x0c, 0x05, 0x0d};
...
uint32_t CON80[] __attribute__((aligned(64))) = {
    0x293d071c, 0x253e1f1a, 0x213f1718, 0x3d382f16, 0x39392714,
    0x353a3f12, 0x313b3710, 0x0d344f0e, 0x0935470c, 0x05365f0a,
    0x01375708, 0x1d306f06, 0x19316704, 0x15327f02, 0x11337700,
    0x6d2c8f3e, 0x692d873c, 0x652e9f3a, 0x612f9738, 0x7d28af36,
    0x7929a734, 0x752abf32, 0x712bb730, 0x4d24cf2e, 0x4925c72c};

/* calculate p0 + p1 + 2*p2 + 3*p3 in GF[2^4] with caract. poly = x^4 + x + 1 */
static inline uint8_t polyEval(uint8_t p0, uint8_t p1, uint8_t p2, uint8_t p3) {
...
static inline uint16_t F(uint16_t x) {
    uint8_t x0;
    uint8_t x1;
    uint8_t x2;
    uint8_t x3;
...
static inline void RP(uint16_t *x0, uint16_t *x1, uint16_t *x2, uint16_t *x3) {
    uint16_t y0;
    uint16_t y1;
    uint16_t y2;
    uint16_t y3;
