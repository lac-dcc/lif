...
# %bb.0:
	...
	leaq	(%rbx,%rbx), %rax
	movq	%rax, %r11
	xorq	$69649, %r11            # imm = 0x11011
	testw	%bx, %bx
	cmovnsq	%rax, %r11
	cmpq	$5, %rbp
	cmovgq	-128(%rsp), %r10        # 8-byte Folded Reload
	movq	%r10, -128(%rsp)        # 8-byte Spill
	leaq	(%r11,%r11), %rax
	movq	%rax, %r9
	xorq	$69649, %r9             # imm = 0x11011
	testw	%r11w, %r11w
	cmovnsq	%rax, %r9
	cmpq	$6, %rbp
	movq	-120(%rsp), %rax        # 8-byte Reload
	...
	cmovgq	8(%rsp), %rdi           # 8-byte Folded Reload
	movq	%rdi, -88(%rsp)         # 8-byte Spill
	leaq	(%rax,%rax), %r10
	movq	%r10, %rdi
	xorq	$69649, %rdi            # imm = 0x11011
	testw	%ax, %ax
	cmovnsq	%r10, %rdi
	...
	testb	$1, %r10b
	cmovneq	%rsi, %r12
	cmpq	$11, -72(%rsp)          # 8-byte Folded Reload
	cmovgq	%rsi, %r12
	movq	%rdi, (%r12)
	addq	$24, %rsp
	popq	%rbx
