...
.Ltmp1:
	...
	movq	$0, -20(%rbp)
.Ltmp2:
	.loc	1 12 18                 # mu/sources/mu2.c:12:18
	testb	$1, (%rdi)
.Ltmp3:
	.loc	1 12 13 is_stmt 0       # mu/sources/mu2.c:12:13
	jne	.LBB0_1
.Ltmp4:
# %bb.2:
	#DEBUG_VALUE: mu:i <- 0
	#DEBUG_VALUE: mu:a <- $rdi
	.loc	1 13 18 is_stmt 1       # mu/sources/mu2.c:13:18
	testb	$1, 4(%rdi)
.Ltmp5:
	.loc	1 13 13 is_stmt 0       # mu/sources/mu2.c:13:13
	jne	.LBB0_3
.Ltmp6:
.LBB0_4:
	#DEBUG_VALUE: mu:i <- 0
	#DEBUG_VALUE: mu:a <- $rdi
	.loc	1 14 18 is_stmt 1       # mu/sources/mu2.c:14:18
	testb	$1, 8(%rdi)
.Ltmp7:
	.loc	1 14 13 is_stmt 0       # mu/sources/mu2.c:14:13
	je	.LBB0_6
.Ltmp8:
.LBB0_5:
	#DEBUG_VALUE: mu:i <- 0
...
.LBB0_1:
	...
	orb	$1, -12(%rbp)
.Ltmp292:
	.loc	1 13 18                 # mu/sources/mu2.c:13:18
	testb	$1, 4(%rdi)
.Ltmp293:
	.loc	1 13 13 is_stmt 0       # mu/sources/mu2.c:13:13
	je	.LBB0_4
...
.LBB0_7:
	#DEBUG_VALUE: mu:i <- 1
	#DEBUG_VALUE: mu:a <- $rdi
	.loc	1 12 28 is_stmt 1       # mu/sources/mu2.c:12:28
	orb	$1, -12(%rbp)
.Ltmp298:
	.loc	1 13 18                 # mu/sources/mu2.c:13:18
	testb	$1, 4(%rdi)
...
.LBB0_194:                              # %CallStackCheckFailBlk
	#DEBUG_VALUE: mu:i <- 32
	#DEBUG_VALUE: mu:a <- $rdi
	.loc	1 0 0                   # mu/sources/mu2.c:0:0
