...
.Ltmp1:
	#DEBUG_VALUE: mu:i <- 0
	.loc	1 0 24 is_stmt 0        # mu/sources/mu2.c:0:24
	movb	$1, -214(%rbp)
.Ltmp2:
	.loc	1 9 14 is_stmt 1        # mu/sources/mu2.c:9:14
	movq	$0, -20(%rbp)
.Ltmp3:
	.loc	1 12 13                 # mu/sources/mu2.c:12:13
	movl	(%rdi), %eax
...
.Ltmp193:
	#DEBUG_VALUE: mu:i <- 32
	.loc	1 0 14 is_stmt 0        # mu/sources/mu2.c:0:14
	movl	-20(%rbp), %eax
.Ltmp194:
	.loc	1 19 10 is_stmt 1       # mu/sources/mu2.c:19:10
	movl	%eax, (%rdi)
	movl	-16(%rbp), %eax
	.loc	1 20 10                 # mu/sources/mu2.c:20:10
	movl	%eax, 4(%rdi)
	movl	-12(%rbp), %eax
	.loc	1 21 10                 # mu/sources/mu2.c:21:10
	movl	%eax, 8(%rdi)
	movb	$1, -21(%rbp)
	movq	%fs:40, %rax
	cmpq	-8(%rbp), %rax
...
# %bb.1:                                # %SP_return
	#DEBUG_VALUE: mu:i <- 32
	#DEBUG_VALUE: mu:a <- $rdi
	.loc	1 22 1                  # mu/sources/mu2.c:22:1
	addq	$224, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
