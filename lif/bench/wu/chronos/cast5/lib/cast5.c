...
static const uint32_t s1[256] __attribute__((aligned(64))) = {
    ...
    0xd5ea50f1, 0x85a92872, 0xaf1fbda7, 0xd4234870, 0xa7870bf3, 0x2d3b4d9,
...
static const uint32_t s5[256] __attribute__((aligned(64))) = {
...
static const uint32_t s6[256] __attribute__((aligned(64))) = {
...
static const uint32_t s7[256] __attribute__((aligned(64))) = {
...
static const uint32_t sb8[256] __attribute__((aligned(64))) = {
...
void cast5_encrypt(struct cast5_ctx *c, uint8_t *outbuf, const uint8_t *inbuf,
                   int rr) {
    const uint32_t *src = (const uint32_t *)inbuf;
    uint32_t *dst = (uint32_t *)outbuf;
    uint32_t l, r, t;
    uint32_t I; /* used by the Fx macros */
    uint32_t *Km;
    uint8_t *Kr;
    ...
    t = l;
    l = r;
    r = t ^ F2(r, Km[10], Kr[10]);
    t = l;
    l = r;
    r = t ^ F3(r, Km[11], Kr[11]);
    // if (!rr) {
    t = l;
    l = r;
    r = t ^ F1(r, Km[12], Kr[12]);
    t = l;
    l = r;
    r = t ^ F2(r, Km[13], Kr[13]);
    t = l;
    l = r;
    r = t ^ F3(r, Km[14], Kr[14]);
    t = l;
    l = r;
    r = t ^ F1(r, Km[15], Kr[15]);
    //}
...
void cast5_decrypt(struct cast5_ctx *c, uint8_t *outbuf, const uint8_t *inbuf,
                   int rr) {
    const uint32_t *src = (const uint32_t *)inbuf;
    uint32_t *dst = (uint32_t *)outbuf;
    uint32_t l, r, t;
...
void key_schedule(uint32_t *x, uint32_t *z, uint32_t *k) {

#define xi(i) ((x[(i) / 4] >> (8 * (3 - ((i) % 4)))) & 0xff)
#define zi(i) ((z[(i) / 4] >> (8 * (3 - ((i) % 4)))) & 0xff)

    z[0] =
        x[0] ^ s5[xi(13)] ^ s6[xi(15)] ^ s7[xi(12)] ^ sb8[xi(14)] ^ s7[xi(8)];
    z[1] = x[2] ^ s5[zi(0)] ^ s6[zi(2)] ^ s7[zi(1)] ^ sb8[zi(3)] ^ sb8[xi(10)];
    z[2] = x[3] ^ s5[zi(7)] ^ s6[zi(6)] ^ s7[zi(5)] ^ sb8[zi(4)] ^ s5[xi(9)];
    z[3] = x[1] ^ s5[zi(10)] ^ s6[zi(9)] ^ s7[zi(11)] ^ sb8[zi(8)] ^ s6[xi(11)];
    k[0] = s5[zi(8)] ^ s6[zi(9)] ^ s7[zi(7)] ^ sb8[zi(6)] ^ s5[zi(2)];
    k[1] = s5[zi(10)] ^ s6[zi(11)] ^ s7[zi(5)] ^ sb8[zi(4)] ^ s6[zi(6)];
    k[2] = s5[zi(12)] ^ s6[zi(13)] ^ s7[zi(3)] ^ sb8[zi(2)] ^ s7[zi(9)];
    k[3] = s5[zi(14)] ^ s6[zi(15)] ^ s7[zi(1)] ^ sb8[zi(0)] ^ sb8[zi(12)];

    x[0] = z[2] ^ s5[zi(5)] ^ s6[zi(7)] ^ s7[zi(4)] ^ sb8[zi(6)] ^ s7[zi(0)];
    x[1] = z[0] ^ s5[xi(0)] ^ s6[xi(2)] ^ s7[xi(1)] ^ sb8[xi(3)] ^ sb8[zi(2)];
    x[2] = z[1] ^ s5[xi(7)] ^ s6[xi(6)] ^ s7[xi(5)] ^ sb8[xi(4)] ^ s5[zi(1)];
    x[3] = z[3] ^ s5[xi(10)] ^ s6[xi(9)] ^ s7[xi(11)] ^ sb8[xi(8)] ^ s6[zi(3)];
    k[4] = s5[xi(3)] ^ s6[xi(2)] ^ s7[xi(12)] ^ sb8[xi(13)] ^ s5[xi(8)];
    k[5] = s5[xi(1)] ^ s6[xi(0)] ^ s7[xi(14)] ^ sb8[xi(15)] ^ s6[xi(13)];
    k[6] = s5[xi(7)] ^ s6[xi(6)] ^ s7[xi(8)] ^ sb8[xi(9)] ^ s7[xi(3)];
    k[7] = s5[xi(5)] ^ s6[xi(4)] ^ s7[xi(10)] ^ sb8[xi(11)] ^ sb8[xi(7)];
    ...
    z[2] = x[3] ^ s5[zi(7)] ^ s6[zi(6)] ^ s7[zi(5)] ^ sb8[zi(4)] ^ s5[xi(9)];
    z[3] = x[1] ^ s5[zi(10)] ^ s6[zi(9)] ^ s7[zi(11)] ^ sb8[zi(8)] ^ s6[xi(11)];
    k[8] = s5[zi(3)] ^ s6[zi(2)] ^ s7[zi(12)] ^ sb8[zi(13)] ^ s5[zi(9)];
    k[9] = s5[zi(1)] ^ s6[zi(0)] ^ s7[zi(14)] ^ sb8[zi(15)] ^ s6[zi(12)];
    k[10] = s5[zi(7)] ^ s6[zi(6)] ^ s7[zi(8)] ^ sb8[zi(9)] ^ s7[zi(2)];
    k[11] = s5[zi(5)] ^ s6[zi(4)] ^ s7[zi(10)] ^ sb8[zi(11)] ^ sb8[zi(6)];
    ...
    k[13] = s5[xi(10)] ^ s6[xi(11)] ^ s7[xi(5)] ^ sb8[xi(4)] ^ s6[xi(7)];
    k[14] = s5[xi(12)] ^ s6[xi(13)] ^ s7[xi(3)] ^ sb8[xi(2)] ^ s7[xi(8)];
    k[15] = s5[xi(14)] ^ s6[xi(15)] ^ s7[xi(1)] ^ sb8[xi(0)] ^ sb8[xi(13)];
...
int cast5_setkey(uint8_t *key, struct cast5_ctx *c, unsigned key_len) {
    ...
    for (i = 0; i < 16; i++) c->Km[i] = k[i];

    key_schedule(x, z, k);

    for (i = 0; i < 16; i++) c->Kr[i] = k[i] & 0x1f;
    return 0;
}
