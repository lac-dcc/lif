 ...
 * which can be represented naturally by uint8_ts (just substitute x=2).  In
 * that form, GF(2^8) addition is the same as bitwise XOR, but GF(2^8)
...
static const uint16_t poly_to_exp[256] __attribute__((aligned(64))) = {
    492,  };
...
static uint8_t calc_sb_tbl[512] __attribute__((aligned(64))) = {
    ,
...
#define CALC_SB256(i, a, b, c, d, e, f, g, h)                                  \
    CALC_SB256_2(i, a, b);                                                     \
    CALC_SB256_2((i) + 1, c, d);                                               \
    CALC_SB256_2((i) + 2, e, f);                                               \
    CALC_SB256_2((i) + 3, g, h)

/* Macros to calculate the whitening and round subkeys.  CALC_K_2 computes the
 * last two stages of the h() function for a given index (either 2i or 2i+1).
 * a, b, c, and d are the four uint8_ts going into the last two stages.  For
 * 128-bit keys, this is the entire h() function and a and c are the index
 * preprocessed through q0 and q1 respectively; for longer keys they are the
 * output of previous stages.  j is the index of the first key uint8_t to use.
 ...
 * key uint8_t to use.  CALC_K256 is identical to CALC_K but for using the
...
int do_twofish_setkey(const uint8_t *key, TWOFISH_context *ctx,
    ...
    /* The S vector used to key the S-boxes, split up into individual uint8_ts.
    ...
    /* Check key length. */
    if (((keylen - 16) | 16) != 16) return GPG_ERR_INV_KEYLEN;
    ...
    //     */ CALC_S (si, sj, sk, sl, 17, 0x2D, 0xA4, 0x44, 0x8A); /* A4 56 A1
    //     55 */ CALC_S (si, sj, sk, sl, 18, 0x8A, 0xD5, 0xBF, 0xD1); /* 55 82
    //     FC 87 */ CALC_S (si, sj, sk, sl, 19, 0xD1, 0x7F, 0x3D, 0x99); /* 87
    //     F3 C1 5A */ CALC_S (si, sj, sk, sl, 20, 0x99, 0x46, 0x66, 0x96); /*
    //     5A 1E 47 58 */ CALC_S (si, sj, sk, sl, 21, 0x96, 0x3C, 0x5B, 0xED);
    //     /* 58 C6 AE DB */ CALC_S (si, sj, sk, sl, 22, 0xED, 0x37, 0x4F,
    //     0xE0); /* DB 68 3D 9E */ CALC_S (si, sj, sk, sl, 23, 0xE0, 0xD0,
    //     0x8C, 0x17); /* 9E E5 19 03 */ CALC_S (sm, sn, so, sp, 24, 0x00,
    //     0x2D, 0x01, 0x2D); /* 01 A4 02 A4 */ CALC_S (sm, sn, so, sp, 25,
    //     0x2D, 0xA4, 0x44, 0x8A); /* A4 56 A1 55 */ CALC_S (sm, sn, so, sp,
    //     26, 0x8A, 0xD5, 0xBF, 0xD1); /* 55 82 FC 87 */ CALC_S (sm, sn, so,
    //     sp, 27, 0xD1, 0x7F, 0x3D, 0x99); /* 87 F3 C1 5A */ CALC_S (sm, sn,
    //     so, sp, 28, 0x99, 0x46, 0x66, 0x96); /* 5A 1E 47 58 */ CALC_S (sm,
    //     sn, so, sp, 29, 0x96, 0x3C, 0x5B, 0xED); /* 58 C6 AE DB */ CALC_S
    //     (sm, sn, so, sp, 30, 0xED, 0x37, 0x4F, 0xE0); /* DB 68 3D 9E */
...
// static int
// twofish_setkey (void *context, const uint8_t *key, unsigned int keylen)
// {
...
// #ifdef USE_AVX2
//   ctx->use_avx2 = 0;
//   if ((hwfeatures & HWF_INTEL_AVX2) && (hwfeatures &
...
extern void _gcry_twofish_amd64_ctr_enc(const TWOFISH_context *c, uint8_t *out,
                                        const uint8_t *in, uint8_t *ctr);

extern void _gcry_twofish_amd64_cbc_dec(const TWOFISH_context *c, uint8_t *out,
                                        const uint8_t *in, uint8_t *iv);

extern void _gcry_twofish_amd64_cfb_dec(const TWOFISH_context *c, uint8_t *out,
                                        const uint8_t *in, uint8_t *iv);

extern void _gcry_twofish_amd64_ocb_enc(const TWOFISH_context *ctx,
                                        uint8_t *out, const uint8_t *in,
                                        uint8_t *offset, uint8_t *checksum,
                                        const u64 Ls[3]);

extern void _gcry_twofish_amd64_ocb_dec(const TWOFISH_context *ctx,
                                        uint8_t *out, const uint8_t *in,
                                        uint8_t *offset, uint8_t *checksum,
                                        const u64 Ls[3]);

extern void _gcry_twofish_amd64_ocb_auth(const TWOFISH_context *ctx,
                                         const uint8_t *abuf, uint8_t *offset,
                                         uint8_t *checksum, const u64 Ls[3]);
...
static inline void call_sysv_fn5(const void *fn, const void *arg1,
                                 const void *arg2, const void *arg3,
...
static inline void call_sysv_fn6(const void *fn, const void *arg1,
                                 const void *arg2, const void *arg3,
                                 const void *arg4, const void *arg5,
                                 const void *arg6) {
    /* Call SystemV ABI function without storing non-volatile XMM registers,
    ...
    asm volatile("movq %[arg5], %%r8\n\t"
                 ...
                 "callq *%0\n\t"
                 : "+a"(fn), "+D"(arg1), "+S"(arg2), "+d"(arg3), "+c"(arg4)
                 : [ arg5 ] "g"(arg5), [ arg6 ] "g"(arg6)
                 : "cc", "memory", "r8", "r9", "r10", "r11");
}
#endif

static inline void twofish_amd64_encrypt_block(const TWOFISH_context *c,
                                               uint8_t *out,
                                               const uint8_t *in) {
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static inline void twofish_amd64_decrypt_block(const TWOFISH_context *c,
                                               uint8_t *out,
                                               const uint8_t *in) {
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static inline void twofish_amd64_ctr_enc(const TWOFISH_context *c, uint8_t *out,
                                         const uint8_t *in, uint8_t *ctr) {
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static inline void twofish_amd64_cbc_dec(const TWOFISH_context *c, uint8_t *out,
                                         const uint8_t *in, uint8_t *iv) {
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static inline void twofish_amd64_cfb_dec(const TWOFISH_context *c, uint8_t *out,
                                         const uint8_t *in, uint8_t *iv) {
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
static inline void twofish_amd64_ocb_enc(const TWOFISH_context *ctx,
                                         uint8_t *out, const uint8_t *in,
                                         uint8_t *offset, uint8_t *checksum,
                                         const u64 Ls[3]) {
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
    call_sysv_fn6(_gcry_twofish_amd64_ocb_enc, ctx, out, in, offset, checksum,
                  Ls);
#else
...
static inline void twofish_amd64_ocb_dec(const TWOFISH_context *ctx,
                                         uint8_t *out, const uint8_t *in,
                                         uint8_t *offset, uint8_t *checksum,
                                         const u64 Ls[3]) {
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
    call_sysv_fn6(_gcry_twofish_amd64_ocb_dec, ctx, out, in, offset, checksum,
                  Ls);
#else
...
static inline void twofish_amd64_ocb_auth(const TWOFISH_context *ctx,
                                          const uint8_t *abuf, uint8_t *offset,
                                          uint8_t *checksum, const u64 Ls[3]) {
#ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
    call_sysv_fn5(_gcry_twofish_amd64_ocb_auth, ctx, abuf, offset, checksum,
                  Ls);
#else
...
/* Macros to convert the input and output uint8_ts into 32-bit words,
...
static unsigned int twofish_encrypt(void *context, uint8_t *out,
                                    const uint8_t *in) {
    TWOFISH_context *ctx = context;
...
unsigned int twofish_encrypt(void *context, uint8_t *out, const uint8_t *in) {
...
static unsigned int twofish_decrypt(void *context, uint8_t *out,
                                    const uint8_t *in) {
    TWOFISH_context *ctx = context;
...
static void do_twofish_decrypt(const TWOFISH_context *ctx, uint8_t *out,
                               const uint8_t *in) {
    /* The four 32-bit chunks of the text. */
    uint32_t a, b, c, d;
...
unsigned int twofish_decrypt(void *context, uint8_t *out, const uint8_t *in) {
    TWOFISH_context *ctx = (TWOFISH_context *)context;
...
void _gcry_twofish_ctr_enc(void *context, unsigned char *ctr, void *outbuf_arg,
    ...
    if (ctx->use_avx2) {
        ...
        if (did_use_avx2) {
            ...
            if (nblocks == 0) burn_stack_depth = 0;
        }
    }
#endif
...
#ifdef USE_AMD64_ASM
    {
        ...
        while (nblocks >= 3) {
            ...
            burn = 8 * sizeof(void *);
            if (burn > burn_stack_depth) burn_stack_depth = burn;
        }
...
void _gcry_twofish_cbc_dec(void *context, unsigned char *iv, void *outbuf_arg,
                           const void *inbuf_arg, size_t nblocks) {
    TWOFISH_context *ctx = context;
    unsigned char *outbuf = outbuf_arg;
    const unsigned char *inbuf = inbuf_arg;
...
/* Bulk decryption of complete blocks in CFB mode.  This function is only
   intended for the bulk encryption feature of cipher.c. */
void _gcry_twofish_cfb_dec(void *context, unsigned char *iv, void *outbuf_arg,
                           const void *inbuf_arg, size_t nblocks) {
    TWOFISH_context *ctx = context;
    unsigned char *outbuf = outbuf_arg;
    const unsigned char *inbuf = inbuf_arg;
...
size_t _gcry_twofish_ocb_crypt(gcry_cipher_hd_t c, void *outbuf_arg,
...

    {
        ...
        while (nblocks >= 3) {
            ...
            if (encrypt)
                twofish_amd64_ocb_enc(ctx, outbuf, inbuf, c->u_iv.iv,
                                      c->u_ctr.ctr, Ls);
            else
                twofish_amd64_ocb_dec(ctx, outbuf, inbuf, c->u_iv.iv,
                                      c->u_ctr.ctr, Ls);
...
static const char *selftest_ctr(void) {
...
static const char *selftest(void) {
    ...
    uint8_t scratch[16]; /* Encryption/decryption result buffer. */
    const char *r;
    ...
    static uint8_t plaintext[16] = {0xD4, 0x91, 0xDB, 0x16, 0xE7, 0xB1,
                                    0xC3, 0x9E, 0x86, 0xCB, 0x08, 0x6B,
                                    0x78, 0x9F, 0x54, 0x19};
    static uint8_t key[16] = {0x9F, 0x58, 0x9F, 0x5C, 0xF6, 0x12, 0x2C, 0x32,
                              0xB6, 0xBF, 0xEC, 0x2F, 0x2A, 0xE8, 0xC3, 0x5A};
    static const uint8_t ciphertext[16] = {0x01, 0x9F, 0x98, 0x09, 0xDE, 0x17,
                                           0x11, 0x85, 0x8F, 0xAA, 0xC3, 0xA3,
                                           0xBA, 0x20, 0xFB, 0xC3};
    static uint8_t plaintext_256[16] = {0x90, 0xAF, 0xE9, 0x1B, 0xB2, 0x88,
                                        0x54, 0x4F, 0x2C, 0x32, 0xDC, 0x23,
                                        0x9B, 0x26, 0x35, 0xE6};
    static uint8_t key_256[32] = {
        0xD4, 0x3B, 0xB7, 0x55, 0x6E, 0xA3, 0x2E, 0x46, 0xF2, 0xA2, 0x82,
        0xB7, 0xD4, 0x5B, 0x4E, 0x0D, 0x57, 0xFF, 0x73, 0x9D, 0x4D, 0xC9,
        0x2C, 0x1B, 0xD7, 0xFC, 0x01, 0x70, 0x0C, 0xC8, 0x21, 0x6F};
    static const uint8_t ciphertext_256[16] = {
    ...
    if ((r = selftest_ctr()) != NULL) return r;
    if ((r = selftest_cbc()) != NULL) return r;
    if ((r = selftest_cfb()) != NULL) return r;
