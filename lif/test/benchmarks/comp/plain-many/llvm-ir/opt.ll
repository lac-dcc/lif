...
for.end20:                                        ; preds = %for.body12
  ...
  %call24 = call i32 @comp(i32** noundef nonnull %2, i32* noundef %9, i32 noundef 5, i32 noundef %10)
  store i32 %call24, i32* %r, align 4
  %11 = bitcast i32* %r to i8*
  %call25 = call i64 @write(i32 noundef 1, i8* noundef nonnull %11, i64 noundef 4) #5
  ret i32 0
}
