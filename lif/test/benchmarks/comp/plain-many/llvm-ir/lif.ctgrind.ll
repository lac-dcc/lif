...
for.end20:                                        ; preds = %for.cond9
  ...
  store volatile i64 %26, i64* %arrayidx25, align 8
  ...
  store volatile i64 %mul27, i64* %arrayidx28, align 16
  ...
  %arrayidx32 = getelementptr inbounds [6 x i64], [6 x i64]* %_zzq_args, i64 0, i64 0
  %28 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* %arrayidx32, i64 0) #4, !srcloc !11
  store volatile i64 %28, i64* %_zzq_result, align 8
  %29 = load volatile i64, i64* %_zzq_result, align 8
  ...
  store i32* %30, i32** %arg.unwrapped23, align 8
  %call33 = call i32 @comp(%"i32*ptr.wrapped.ty"* %arg.wrapped, %i32ptr.wrapped.ty* %arg.wrapped22, i32 5, i32 %31)
  store i32 %call33, i32* %r, align 4
  %32 = bitcast i32* %r to i8*
  %call34 = call i64 @write(i32 noundef 1, i8* noundef %32, i64 noundef 4)
  ret i32 0
}
