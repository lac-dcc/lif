...
for.end20:                                        ; preds = %for.cond9
  ...
  store volatile i64 %14, i64* %arrayidx25, align 8
  ...
  %16 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* %arrayidx32, i64 0) #4, !srcloc !9
  store volatile i64 %16, i64* %_zzq_result, align 8
  %17 = load volatile i64, i64* %_zzq_result, align 8
  %18 = load i32*, i32** %b, align 8
  %19 = load i32, i32* %m, align 4
  %call33 = call i32 @comp(i32** noundef %2, i32* noundef %18, i32 noundef 5, i32 noundef %19)
  store i32 %call33, i32* %r, align 4
  %20 = bitcast i32* %r to i8*
  %call34 = call i64 @write(i32 noundef 1, i8* noundef %20, i64 noundef 4)
  ret i32 0
}
...
!8 = distinct !{!8, !7}
!9 = !{i64 2148289948, i64 2148289984, i64 2148290052}
