...
for.end20:                                        ; preds = %for.body12
  ...
  %14 = bitcast %"i32*ptr.wrapped.ty"* %arg.wrapped to i8**
  ...
  store i32* %12, i32** %arg.unwrapped23, align 8
  %call33 = call i32 @comp(%"i32*ptr.wrapped.ty"* nonnull %arg.wrapped, %i32ptr.wrapped.ty* nonnull %arg.wrapped22, i32 5, i32 %13)
  store i32 %call33, i32* %r, align 4
  %15 = bitcast i32* %r to i8*
  %call34 = call i64 @write(i32 noundef 1, i8* noundef nonnull %15, i64 noundef 4) #5
  ret i32 0
}
