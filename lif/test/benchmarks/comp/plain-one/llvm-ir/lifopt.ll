...
entry:
  ...
  %7 = bitcast %i32ptr.wrapped.ty* %arg.wrapped to i8**
  ...
  store i32* %5, i32** %arg.unwrapped2, align 8
  %call13 = call i32 @comp(%i32ptr.wrapped.ty* nonnull %arg.wrapped, %i32ptr.wrapped.ty* nonnull %arg.wrapped1, i32 %6)
