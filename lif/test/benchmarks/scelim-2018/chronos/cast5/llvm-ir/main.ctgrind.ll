...
entry:
  ...
  store volatile i64 32, i64* %arrayidx7, align 16
  ...
  %arraydecay15 = getelementptr inbounds [64 x i8], [64 x i8]* %in, i64 0, i64 0
  ...
  store volatile i64 64, i64* %arrayidx17, align 16
  ...
  %call24 = call i32 @cast5_setkey(i8* noundef %arraydecay23, %struct.cast5_ctx* noundef %ctx, i32 noundef 16)
  %arraydecay25 = getelementptr inbounds [64 x i8], [64 x i8]* %out, i64 0, i64 0
  %arraydecay26 = getelementptr inbounds [64 x i8], [64 x i8]* %in, i64 0, i64 0
  %rr = getelementptr inbounds %struct.cast5_ctx, %struct.cast5_ctx* %ctx, i32 0, i32 2
  %7 = load i32, i32* %rr, align 4
  call void @cast5_encrypt(%struct.cast5_ctx* noundef %ctx, i8* noundef %arraydecay25, i8* noundef %arraydecay26, i32 noundef %7)
  %arraydecay27 = getelementptr inbounds [64 x i8], [64 x i8]* %out, i64 0, i64 0
  %call28 = call i64 @write(i32 noundef 1, i8* noundef %arraydecay27, i64 noundef 64)
  ret i32 0
}
...
!6 = !{i64 2148347385, i64 2148347421, i64 2148347489}
!7 = !{i64 2148349002, i64 2148349038, i64 2148349106}
