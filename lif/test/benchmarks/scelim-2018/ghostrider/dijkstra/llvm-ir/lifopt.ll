...
for.body15:                                       ; preds = %for.body15.preheader, %for.body15
  ...
  %cond.fold55 = or i1 %in.53, %cond.fold49
  %cond.fold56 = or i1 %cond.fold55, %in.52
...
for.cond4.preheader:                              ; preds = %entry, %for.end
...
for.body7:                                        ; preds = %for.cond4.preheader, %for.body7
  ...
  %arrayidx9 = getelementptr inbounds [16 x [16 x i32]], [16 x [16 x i32]]* %in, i64 0, i64 %indvars.iv11, i64 %indvars.iv
  %1 = bitcast i32* %arrayidx9 to i8*
  %call10 = call i64 @read(i32 noundef 0, i8* noundef nonnull %1, i64 noundef 4) #5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 16
  br i1 %exitcond.not, label %for.end, label %for.body7, !llvm.loop !18

for.end:                                          ; preds = %for.body7
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond13.not = icmp eq i64 %indvars.iv.next12, 16
  br i1 %exitcond13.not, label %for.end13, label %for.cond4.preheader, !llvm.loop !19

for.end13:                                        ; preds = %for.end
  %arraydecay = getelementptr inbounds [16 x [16 x i32]], [16 x [16 x i32]]* %in, i64 0, i64 0
  %arraydecay.unwrapped = getelementptr inbounds %"[16 x i32]ptr.wrapped.ty", %"[16 x i32]ptr.wrapped.ty"* %arraydecay.wrapped, i64 0, i32 0
  %arraydecay.wrapped.field0.length.ptr = getelementptr inbounds %"[16 x i32]ptr.wrapped.ty", %"[16 x i32]ptr.wrapped.ty"* %arraydecay.wrapped, i64 0, i32 1
  ...
  %call14 = call i32 @dijkstra(i32 16, i32 0, i32 15, %"[16 x i32]ptr.wrapped.ty"* nonnull %arraydecay.wrapped)
  store i32 %call14, i32* %r, align 4
  %2 = bitcast i32* %r to i8*
  %call15 = call i64 @write(i32 noundef 1, i8* noundef nonnull %2, i64 noundef 4) #5
  ret i32 0
}
