...
for.end:                                          ; preds = %for.cond
  ...
  %8 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* %arrayidx8, i64 0) #3, !srcloc !9
  ...
  %call10 = call i32 @max(i32 1000, %i32ptr.wrapped.ty* %arraydecay9.wrapped)
  store i32 %call10, i32* %r, align 4
  %10 = bitcast i32* %r to i8*
  %call11 = call i64 @write(i32 noundef 1, i8* noundef %10, i64 noundef 4)
  ret i32 0
}
