...
for.cond1:                                        ; preds = %for.inc13, %for.end
  %i.1.rewritten = phi i32 [ 0, %for.end ], [ %inc14, %for.inc13 ]
  %fwedge.taken1.rewritten = phi i1 [ true, %for.end ], [ false, %for.inc13 ]
  %exitpred.frozen2.rewritten = phi i1 [ %cmp2, %for.inc13 ], [ false, %for.end ]
...
if.then:                                          ; preds = %if.else
  ...
  %15 = load volatile i32, i32* %ctsel, align 4
  ...
  store volatile i32 %select.val., i32* %ctsel31, align 4
...
if.end:                                           ; preds = %if.then
  ...
  %cond.fold26 = or i1 false, %22
  %cond.fold27 = or i1 %cond.fold26, %21
  ...
  %idxprom11 = sext i32 %phi.fold to i64
  %arrayidx12 = getelementptr inbounds i32, i32* %c.unwrapped, i64 %idxprom11
  store i32 %add, i32* %arrayidx12, align 4
  br label %for.inc13

for.inc13:                                        ; preds = %if.end
  %24 = load i1, i1* %out.11, align 1
  %cond.fold28 = or i1 false, %24
  store i1 %cond.fold28, i1* %out.12, align 1
  %inc14 = add nsw i32 %i.1.rewritten, 1
  br label %for.cond1, !llvm.loop !8

for.end15:                                        ; preds = %for.cond1
  %25 = load i1, i1* %out.7, align 1
  %26 = xor i1 %cmp2, true
  %in.29 = and i1 %25, %26
