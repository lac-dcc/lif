...
for.end:                                          ; preds = %for.body
  ...
  %2 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* nonnull %arrayidx2, i64 0) #6, !srcloc !9
  ...
  call void @histogram(i32* noundef nonnull %arraydecay, i32* noundef nonnull %arraydecay10)
  %3 = bitcast [1000 x i32]* %out to i8*
  %call12 = call i64 @write(i32 noundef 1, i8* noundef nonnull %3, i64 noundef 4000) #6
  ret i32 0
}
