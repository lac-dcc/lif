...
if.end:                                           ; preds = %if.else, %if.then
  %t.0.in = phi i32 [ %0, %if.then ], [ %.nonneg, %if.else ]
  %t.0 = urem i32 %t.0.in, 1000
  %idxprom92 = zext i32 %t.0 to i64
  %arrayidx10 = getelementptr inbounds i32, i32* %c, i64 %idxprom92
...
!8 = distinct !{!8, !7}
!9 = !{i64 2148114561, i64 2148114597, i64 2148114665}
