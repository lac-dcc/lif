...
entry:
  ...
  store i8* %in_key1, i8** %arraydecay23.unwrapped, align 8
  call void @deskey(%i8ptr.wrapped.ty* nonnull %arraydecay23.wrapped, i16 0)
  ...
  call void @cpkey(%i64ptr.wrapped.ty* nonnull %arraydecay24.wrapped)
  %arraydecay26 = getelementptr inbounds [2 x i64], [2 x i64]* %work, i64 0, i64 0
  %arraydecay25.unwrapped = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay25.wrapped, i64 0, i32 0
  %arraydecay25.wrapped.field0.length.ptr = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay25.wrapped, i64 0, i32 1
  store i64 8, i64* %arraydecay25.wrapped.field0.length.ptr, align 8
  store i8* %in2, i8** %arraydecay25.unwrapped, align 8
  ...
  call void @scrunch(%i8ptr.wrapped.ty* nonnull %arraydecay25.wrapped, %i64ptr.wrapped.ty* nonnull %arraydecay26.wrapped)
  ...
  store i64* %arraydecay24, i64** %arraydecay28.unwrapped, align 8
  ...
  store i64* %arraydecay26, i64** %arraydecay29.unwrapped, align 8
  call void @desfunc(%i64ptr.wrapped.ty* nonnull %arraydecay28.wrapped, %i64ptr.wrapped.ty* nonnull %arraydecay29.wrapped)
  ...
  store i64* %arraydecay26, i64** %arraydecay30.unwrapped, align 8
  %arraydecay31.wrapped.field0.length.ptr = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay31.wrapped, i64 0, i32 1
  store i64 8, i64* %arraydecay31.wrapped.field0.length.ptr, align 8
  %5 = bitcast %i8ptr.wrapped.ty* %arraydecay31.wrapped to i64**
  store i64* %out, i64** %5, align 8
  call void @unscrun(%i64ptr.wrapped.ty* nonnull %arraydecay30.wrapped, %i8ptr.wrapped.ty* nonnull %arraydecay31.wrapped)
