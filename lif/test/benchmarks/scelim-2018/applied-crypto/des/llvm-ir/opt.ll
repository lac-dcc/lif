...
entry:
  ...
  call void @cpkey(i64* noundef nonnull %arraydecay6)
  %arraydecay8 = getelementptr inbounds [2 x i64], [2 x i64]* %work, i64 0, i64 0
  call void @scrunch(i8* noundef nonnull %in2, i64* noundef nonnull %arraydecay8)
  call void @desfunc(i64* noundef nonnull %arraydecay6, i64* noundef nonnull %arraydecay8)
  %arraydecay13 = bitcast i64* %out to i8*
  call void @unscrun(i64* noundef nonnull %arraydecay8, i8* noundef nonnull %arraydecay13)
