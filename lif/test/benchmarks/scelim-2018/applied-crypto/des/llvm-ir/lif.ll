...
if.end100:                                        ; preds = %if.then94
  ...
  %in.93 = and i1 %80, %81
  %cond.fold94 = or i1 false, %79
  %cond.fold95 = or i1 %cond.fold94, %in.93
...
entry:
  ...
  call void @deskey(%i8ptr.wrapped.ty* %arraydecay5.wrapped, i16 0)
  ...
  call void @cpkey(%i64ptr.wrapped.ty* %arraydecay6.wrapped)
  ...
  %arraydecay7.unwrapped = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay7.wrapped, i32 0, i32 0
  %arraydecay7.wrapped.field0.length.ptr = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay7.wrapped, i32 0, i32 1
  store i64 8, i64* %arraydecay7.wrapped.field0.length.ptr, align 8
  store i8* %arraydecay7, i8** %arraydecay7.unwrapped, align 8
  ...
  call void @scrunch(%i8ptr.wrapped.ty* %arraydecay7.wrapped, %i64ptr.wrapped.ty* %arraydecay8.wrapped)
  ...
  call void @desfunc(%i64ptr.wrapped.ty* %arraydecay10.wrapped, %i64ptr.wrapped.ty* %arraydecay11.wrapped)
  ...
  call void @unscrun(%i64ptr.wrapped.ty* %arraydecay12.wrapped, %i8ptr.wrapped.ty* %arraydecay13.wrapped)
