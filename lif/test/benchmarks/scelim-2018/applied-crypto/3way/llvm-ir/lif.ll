...
entry:
  ...
  call void @gamma(%i32ptr.wrapped.ty* %a.unwrapped.wrapped3)
  ...
  call void @pi_2(%i32ptr.wrapped.ty* %a.unwrapped.wrapped5)
  %shadow = alloca i64, align 8
  store i64 0, i64* %shadow, align 8
  ret void
}
...
entry:
  ...
  %arraydecay5.unwrapped = getelementptr inbounds %i32ptr.wrapped.ty, %i32ptr.wrapped.ty* %arraydecay5.wrapped, i32 0, i32 0
  %arraydecay5.wrapped.field0.length.ptr = getelementptr inbounds %i32ptr.wrapped.ty, %i32ptr.wrapped.ty* %arraydecay5.wrapped, i32 0, i32 1
  store i64 3, i64* %arraydecay5.wrapped.field0.length.ptr, align 8
  store i32* %arraydecay5, i32** %arraydecay5.unwrapped, align 8
  call void @twy_key(%i32ptr.wrapped.ty* %arraydecay5.wrapped, %struct.twy_ctx* %gc)
  %arraydecay6 = getelementptr inbounds [3 x i32], [3 x i32]* %in, i64 0, i64 0
  %arraydecay6.unwrapped = getelementptr inbounds %i32ptr.wrapped.ty, %i32ptr.wrapped.ty* %arraydecay6.wrapped, i32 0, i32 0
  %arraydecay6.wrapped.field0.length.ptr = getelementptr inbounds %i32ptr.wrapped.ty, %i32ptr.wrapped.ty* %arraydecay6.wrapped, i32 0, i32 1
  store i64 3, i64* %arraydecay6.wrapped.field0.length.ptr, align 8
  store i32* %arraydecay6, i32** %arraydecay6.unwrapped, align 8
  call void @encrypt(%struct.twy_ctx* %gc, %i32ptr.wrapped.ty* %arraydecay6.wrapped)
