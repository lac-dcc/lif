...
entry:
  ...
  call void @gamma(%i32ptr.wrapped.ty* nonnull %a.unwrapped.wrapped3)
  ...
  call void @pi_2(%i32ptr.wrapped.ty* nonnull %a.unwrapped.wrapped5)
  ret void
}
...
entry:
  %arraydecay5.wrapped = alloca %i32ptr.wrapped.ty, align 8
  %arraydecay6.wrapped = alloca %i32ptr.wrapped.ty, align 8
  ...
  %arraydecay5.unwrapped = getelementptr inbounds %i32ptr.wrapped.ty, %i32ptr.wrapped.ty* %arraydecay5.wrapped, i64 0, i32 0
  %arraydecay5.wrapped.field0.length.ptr = getelementptr inbounds %i32ptr.wrapped.ty, %i32ptr.wrapped.ty* %arraydecay5.wrapped, i64 0, i32 1
  store i64 3, i64* %arraydecay5.wrapped.field0.length.ptr, align 8
  store i32* %arraydecay, i32** %arraydecay5.unwrapped, align 8
  call void @twy_key(%i32ptr.wrapped.ty* nonnull %arraydecay5.wrapped, %struct.twy_ctx* nonnull %gc)
  %arraydecay6.unwrapped = getelementptr inbounds %i32ptr.wrapped.ty, %i32ptr.wrapped.ty* %arraydecay6.wrapped, i64 0, i32 0
  %arraydecay6.wrapped.field0.length.ptr = getelementptr inbounds %i32ptr.wrapped.ty, %i32ptr.wrapped.ty* %arraydecay6.wrapped, i64 0, i32 1
  store i64 3, i64* %arraydecay6.wrapped.field0.length.ptr, align 8
  store i32* %arraydecay3, i32** %arraydecay6.unwrapped, align 8
  call void @encrypt(%struct.twy_ctx* nonnull %gc, %i32ptr.wrapped.ty* nonnull %arraydecay6.wrapped)
  %call8 = call i64 @write(i32 noundef 1, i8* noundef nonnull %in2, i64 noundef 12) #5
  ret i32 0
}
