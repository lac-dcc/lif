...
entry:
  ...
  store i8* %in_key2, i8** %arraydecay5.unwrapped, align 8
  call void @setlokikey(%i8ptr.wrapped.ty* nonnull %arraydecay5.wrapped, %struct.loki_ctx* nonnull %lc)
  %arraydecay6.unwrapped = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay6.wrapped, i64 0, i32 0
  %arraydecay6.wrapped.field0.length.ptr = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay6.wrapped, i64 0, i32 1
  store i64 8, i64* %arraydecay6.wrapped.field0.length.ptr, align 8
  store i8* %in1, i8** %arraydecay6.unwrapped, align 8
  call void @enloki(%struct.loki_ctx* nonnull %lc, %i8ptr.wrapped.ty* nonnull %arraydecay6.wrapped)
  %call8 = call i64 @write(i32 noundef 1, i8* noundef nonnull %in1, i64 noundef 8) #6
  ret i32 0
}
