...
if.end:                                           ; preds = %if.then
  ...
  %cond.fold12 = or i1 %cond.fold11, %14
...
if.end9:                                          ; preds = %if.then8, %while.body
  ...
  %cond.fold18 = or i1 %cond.fold17, %12
  ...
  %cond.fold24 = or i1 false, %in.16
  %cond.fold25 = or i1 %cond.fold24, %12
...
entry:
  ...
  call void @setlokikey(%i8ptr.wrapped.ty* %arraydecay23.wrapped, %struct.loki_ctx* %lc)
  ...
  call void @enloki(%struct.loki_ctx* %lc, %i8ptr.wrapped.ty* %arraydecay24.wrapped)
