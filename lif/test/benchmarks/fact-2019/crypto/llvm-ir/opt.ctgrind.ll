...
define dso_local i32 @_crypto_stream_salsa20(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, i8* nocapture noundef readonly %n, i8* noundef %k) #0 {
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %kcopy3, i8* noundef nonnull align 1 dereferenceable(32) %k, i64 32, i1 false)
  ...
  %1 = bitcast i8* %n to i64*
  %2 = bitcast [16 x i8]* %input to i64*
  %3 = load i64, i64* %1, align 1
  store i64 %3, i64* %2, align 16
  ...
  %cmp85.not = icmp eq i64 %5, 0
  br i1 %cmp85.not, label %for.end31, label %for.body10.lr.ph
...
for.body10:                                       ; preds = %for.inc29.for.body10_crit_edge, %for.body10.lr.ph
  %6 = phi i8* [ %0, %for.body10.lr.ph ], [ %.pre, %for.inc29.for.body10_crit_edge ]
  %indvars.iv12 = phi i64 [ 0, %for.body10.lr.ph ], [ %indvars.iv.next13, %for.inc29.for.body10_crit_edge ]
  %7 = shl i64 %indvars.iv12, 6
  %add.ptr = getelementptr inbounds i8, i8* %6, i64 %7
  call void @_crypto_core_salsa20(i8* noundef %add.ptr, i8* noundef nonnull %input4, i8* noundef nonnull %kcopy3)
...
for.body18:                                       ; preds = %for.body10, %for.body18
  %indvars.iv = phi i64 [ 8, %for.body10 ], [ %indvars.iv.next, %for.body18 ]
  %shr2523 = phi i32 [ 1, %for.body10 ], [ %shr25, %for.body18 ]
  %arrayidx20 = getelementptr inbounds [16 x i8], [16 x i8]* %input, i64 0, i64 %indvars.iv
  %8 = load i8, i8* %arrayidx20, align 1
  %conv21 = zext i8 %8 to i32
  %add = add nuw nsw i32 %shr2523, %conv21
  %conv22 = trunc i32 %add to i8
  store i8 %conv22, i8* %arrayidx20, align 1
  %shr25 = lshr i32 %add, 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 16
  br i1 %exitcond.not, label %for.inc29, label %for.body18, !llvm.loop !6

for.inc29:                                        ; preds = %for.body18
  store i32 %shr25, i32* %u, align 4
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1
  %exitcond16.not = icmp eq i64 %indvars.iv.next13, %wide.trip.count
  br i1 %exitcond16.not, label %for.end31.loopexit, label %for.inc29.for.body10_crit_edge, !llvm.loop !8
...
for.end31.loopexit:                               ; preds = %for.inc29
  %.pre20 = load i64, i64* %len, align 8
  br label %for.end31

for.end31:                                        ; preds = %for.end31.loopexit, %entry
  %9 = phi i64 [ %.pre20, %for.end31.loopexit ], [ %4, %entry ]
...
if.then:                                          ; preds = %for.end31
  call void @_crypto_core_salsa20(i8* noundef nonnull %block32, i8* noundef nonnull %input4, i8* noundef nonnull %kcopy3)
  %10 = load i64, i64* %len, align 8
  %sub = sub i64 %10, %mul33
  %conv44 = trunc i64 %sub to i32
  %cmp477.not = icmp eq i32 %conv44, 0
  br i1 %cmp477.not, label %if.end, label %for.body49.preheader
...
for.body49:                                       ; preds = %for.body49.preheader, %for.body49
  %indvars.iv17 = phi i64 [ 0, %for.body49.preheader ], [ %indvars.iv.next18, %for.body49 ]
  %arrayidx51 = getelementptr inbounds [64 x i8], [64 x i8]* %block, i64 0, i64 %indvars.iv17
  %12 = load i8, i8* %arrayidx51, align 1
  %13 = load i8*, i8** %c_buf, align 8
  %arrayidx53 = getelementptr inbounds i8, i8* %13, i64 %indvars.iv17
  store i8 %12, i8* %arrayidx53, align 1
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %cmp47 = icmp ult i64 %indvars.iv.next18, %11
  br i1 %cmp47, label %for.body49, label %if.end, !llvm.loop !9
...
; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local i32 @_crypto_stream_salsa20_xor_ic(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %m, i8* noundef %n, i64 noundef %ic_val, i8* noundef %k) #0 {
entry:
  ...
  %len = getelementptr inbounds %struct.uint8ptr_wrapped_ty, %struct.uint8ptr_wrapped_ty* %m, i64 0, i32 1
  %2 = load i64, i64* %len, align 8
  %len6 = getelementptr inbounds %struct.uint8ptr_wrapped_ty, %struct.uint8ptr_wrapped_ty* %c, i64 0, i32 1
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %kcopy7, i8* noundef nonnull align 1 dereferenceable(32) %k, i64 32, i1 false)
  ...
  %4 = bitcast i8* %n to i64*
  %5 = bitcast [16 x i8]* %input to i64*
  %6 = load i64, i64* %4, align 1
  store i64 %6, i64* %5, align 16
  br label %for.body15

for.body15:                                       ; preds = %if.end, %for.body15
  %indvars.iv = phi i64 [ 8, %if.end ], [ %indvars.iv.next, %for.body15 ]
  %ic.05 = phi i64 [ %ic_val, %if.end ], [ %shr, %for.body15 ]
  %conv = trunc i64 %ic.05 to i8
  %arrayidx17 = getelementptr inbounds [16 x i8], [16 x i8]* %input, i64 0, i64 %indvars.iv
  store i8 %conv, i8* %arrayidx17, align 1
  %shr = lshr i64 %ic.05, 8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 16
  br i1 %exitcond.not, label %for.end20, label %for.body15, !llvm.loop !10
...
for.end20:                                        ; preds = %for.body15
  ...
  %cmp2410.not = icmp ult i64 %2, 64
  br i1 %cmp2410.not, label %for.end65, label %for.body26.lr.ph
...
for.body26:                                       ; preds = %for.body26.lr.ph, %for.inc63
  %j.011 = phi i64 [ 0, %for.body26.lr.ph ], [ %inc64, %for.inc63 ]
  call void @_crypto_core_salsa20(i8* noundef nonnull %block22, i8* noundef nonnull %input8, i8* noundef nonnull %kcopy7)
  br label %for.body34

for.body34:                                       ; preds = %for.body26, %for.body34
  %indvars.iv17 = phi i64 [ 0, %for.body26 ], [ %indvars.iv.next18, %for.body34 ]
  %7 = load i8*, i8** %m_buf, align 8
  %arrayidx36 = getelementptr inbounds i8, i8* %7, i64 %indvars.iv17
  %8 = load i8, i8* %arrayidx36, align 1
  %arrayidx39 = getelementptr inbounds [64 x i8], [64 x i8]* %block, i64 0, i64 %indvars.iv17
  %9 = load i8, i8* %arrayidx39, align 1
  %xor2 = xor i8 %9, %8
  %10 = load i8*, i8** %c_buf, align 8
  %arrayidx43 = getelementptr inbounds i8, i8* %10, i64 %indvars.iv17
  store i8 %xor2, i8* %arrayidx43, align 1
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %exitcond20.not = icmp eq i64 %indvars.iv.next18, 64
  br i1 %exitcond20.not, label %for.end46, label %for.body34, !llvm.loop !11
...
for.body52:                                       ; preds = %for.end46, %for.body52
  %indvars.iv21 = phi i64 [ 8, %for.end46 ], [ %indvars.iv.next22, %for.body52 ]
  %shr5978 = phi i32 [ 1, %for.end46 ], [ %shr59, %for.body52 ]
  %arrayidx54 = getelementptr inbounds [16 x i8], [16 x i8]* %input, i64 0, i64 %indvars.iv21
  %11 = load i8, i8* %arrayidx54, align 1
  %conv55 = zext i8 %11 to i32
  %add = add nuw nsw i32 %shr5978, %conv55
  ...
  br i1 %exitcond24.not, label %for.inc63, label %for.body52, !llvm.loop !12

for.inc63:                                        ; preds = %for.body52
  store i32 %shr59, i32* %u, align 4
  %inc64 = add nuw nsw i64 %j.011, 1
  %exitcond25.not = icmp eq i64 %inc64, %div
  br i1 %exitcond25.not, label %for.end65.loopexit, label %for.body26, !llvm.loop !13
...
for.end65:                                        ; preds = %for.end65.loopexit, %for.end20
  %12 = phi i64 [ %.pre, %for.end65.loopexit ], [ %2, %for.end20 ]
  %mul = and i64 %2, -64
...
if.then69:                                        ; preds = %for.end65
  %sub = sub i64 %12, %mul
  call void @_crypto_core_salsa20(i8* noundef nonnull %block22, i8* noundef nonnull %input8, i8* noundef nonnull %kcopy7)
  %cmp7712.not = icmp eq i64 %sub, 0
  br i1 %cmp7712.not, label %if.end90, label %for.body79

for.body79:                                       ; preds = %if.then69, %for.body79
  %i75.013 = phi i64 [ %inc88, %for.body79 ], [ 0, %if.then69 ]
  %13 = load i8*, i8** %m_buf, align 8
  %arrayidx80 = getelementptr inbounds i8, i8* %13, i64 %i75.013
  %14 = load i8, i8* %arrayidx80, align 1
  %arrayidx82 = getelementptr inbounds [64 x i8], [64 x i8]* %block, i64 0, i64 %i75.013
  %15 = load i8, i8* %arrayidx82, align 1
  %xor841 = xor i8 %15, %14
  %16 = load i8*, i8** %c_buf, align 8
  %arrayidx86 = getelementptr inbounds i8, i8* %16, i64 %i75.013
  store i8 %xor841, i8* %arrayidx86, align 1
  %inc88 = add nuw i64 %i75.013, 1
  %exitcond26.not = icmp eq i64 %inc88, %sub
  br i1 %exitcond26.not, label %if.end90, label %for.body79, !llvm.loop !14
...
define dso_local void @_crypto_core_salsa20(i8* noundef %output, i8* noundef %input, i8* noundef %k) local_unnamed_addr #5 {
entry:
  ...
  %call = call fastcc i32 @load32_le(i8* noundef %k)
  ...
  %add.ptr = getelementptr inbounds i8, i8* %k, i64 4
  %call14 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr)
  ...
  %add.ptr16 = getelementptr inbounds i8, i8* %k, i64 8
  %call17 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr16)
  ...
  %add.ptr19 = getelementptr inbounds i8, i8* %k, i64 12
  %call20 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr19)
  ...
  %add.ptr22 = getelementptr inbounds i8, i8* %k, i64 16
  %call23 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr22)
  ...
  %add.ptr25 = getelementptr inbounds i8, i8* %k, i64 20
  %call26 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr25)
  ...
  %add.ptr28 = getelementptr inbounds i8, i8* %k, i64 24
  %call29 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr28)
  ...
  %add.ptr31 = getelementptr inbounds i8, i8* %k, i64 28
  %call32 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr31)
  ...
  %call42 = call fastcc i32 @load32_le(i8* noundef %input)
  ...
  %add.ptr44 = getelementptr inbounds i8, i8* %input, i64 4
  %call45 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr44)
  ...
  %add.ptr47 = getelementptr inbounds i8, i8* %input, i64 8
  %call48 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr47)
  ...
  %add.ptr50 = getelementptr inbounds i8, i8* %input, i64 12
  %call51 = call fastcc i32 @load32_le(i8* noundef nonnull %add.ptr50)
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %xor113132 = phi i32 [ %x0.promoted, %entry ], [ %xor113, %for.body ]
  %xor140231 = phi i32 [ %call26, %entry ], [ %xor140, %for.body ]
  %xor122330 = phi i32 [ %call20, %entry ], [ %xor122, %for.body ]
  %xor131429 = phi i32 [ %call48, %entry ], [ %xor131, %for.body ]
  %xor125528 = phi i32 [ %x5.promoted, %entry ], [ %xor125, %for.body ]
  %xor104627 = phi i32 [ %call, %entry ], [ %xor104, %for.body ]
  %xor134726 = phi i32 [ %call51, %entry ], [ %xor134, %for.body ]
  %xor143825 = phi i32 [ %call29, %entry ], [ %xor143, %for.body ]
  %xor137924 = phi i32 [ %x10.promoted, %entry ], [ %xor137, %for.body ]
  %xor1161023 = phi i32 [ %call42, %entry ], [ %xor116, %for.body ]
  %xor1461122 = phi i32 [ %call32, %entry ], [ %xor146, %for.body ]
  %xor1071221 = phi i32 [ %call14, %entry ], [ %xor107, %for.body ]
  %xor1491320 = phi i32 [ %x15.promoted, %entry ], [ %xor149, %for.body ]
  %xor1281419 = phi i32 [ %call23, %entry ], [ %xor128, %for.body ]
  %xor1101518 = phi i32 [ %call17, %entry ], [ %xor110, %for.body ]
  %xor1191617 = phi i32 [ %call45, %entry ], [ %xor119, %for.body ]
  %add = add i32 %xor140231, %xor113132
  %call56 = call fastcc i32 @rotl32(i32 noundef %add, i32 noundef 7)
  %xor = xor i32 %xor122330, %call56
  %add57 = add i32 %xor, %xor113132
  %call58 = call fastcc i32 @rotl32(i32 noundef %add57, i32 noundef 9)
  %xor59 = xor i32 %xor131429, %call58
  %add60 = add i32 %xor59, %xor
  %call61 = call fastcc i32 @rotl32(i32 noundef %add60, i32 noundef 13)
  %xor62 = xor i32 %call61, %xor140231
  %add63 = add i32 %xor62, %xor59
  %call64 = call fastcc i32 @rotl32(i32 noundef %add63, i32 noundef 18)
  %xor65 = xor i32 %call64, %xor113132
  %add66 = add i32 %xor104627, %xor125528
  %call67 = call fastcc i32 @rotl32(i32 noundef %add66, i32 noundef 7)
  %xor68 = xor i32 %xor134726, %call67
  %add69 = add i32 %xor68, %xor125528
  %call70 = call fastcc i32 @rotl32(i32 noundef %add69, i32 noundef 9)
  %xor71 = xor i32 %xor143825, %call70
  %add72 = add i32 %xor71, %xor68
  %call73 = call fastcc i32 @rotl32(i32 noundef %add72, i32 noundef 13)
  %xor74 = xor i32 %call73, %xor104627
  %add75 = add i32 %xor74, %xor71
  %call76 = call fastcc i32 @rotl32(i32 noundef %add75, i32 noundef 18)
  %xor77 = xor i32 %call76, %xor125528
  %add78 = add i32 %xor1161023, %xor137924
  %call79 = call fastcc i32 @rotl32(i32 noundef %add78, i32 noundef 7)
  %xor80 = xor i32 %xor1461122, %call79
  %add81 = add i32 %xor80, %xor137924
  %call82 = call fastcc i32 @rotl32(i32 noundef %add81, i32 noundef 9)
  %xor83 = xor i32 %xor1071221, %call82
  %add84 = add i32 %xor83, %xor80
  %call85 = call fastcc i32 @rotl32(i32 noundef %add84, i32 noundef 13)
  %xor86 = xor i32 %call85, %xor1161023
  %add87 = add i32 %xor86, %xor83
  %call88 = call fastcc i32 @rotl32(i32 noundef %add87, i32 noundef 18)
  %xor89 = xor i32 %call88, %xor137924
  %add90 = add i32 %xor1281419, %xor1491320
  %call91 = call fastcc i32 @rotl32(i32 noundef %add90, i32 noundef 7)
  %xor92 = xor i32 %xor1101518, %call91
  %add93 = add i32 %xor92, %xor1491320
  %call94 = call fastcc i32 @rotl32(i32 noundef %add93, i32 noundef 9)
  %xor95 = xor i32 %xor1191617, %call94
  %add96 = add i32 %xor95, %xor92
  %call97 = call fastcc i32 @rotl32(i32 noundef %add96, i32 noundef 13)
  %xor98 = xor i32 %call97, %xor1281419
  %add99 = add i32 %xor98, %xor95
  %call100 = call fastcc i32 @rotl32(i32 noundef %add99, i32 noundef 18)
  %xor101 = xor i32 %call100, %xor1491320
...
for.end:                                          ; preds = %for.body
  ...
  call fastcc void @store32_le(i8* noundef %0, i32 noundef %add150)
  %1 = load i8*, i8** %output.addr, align 8
  %add.ptr151 = getelementptr inbounds i8, i8* %1, i64 4
  %2 = load i32, i32* %x1, align 4
  %3 = load i32, i32* %j1, align 4
  %add152 = add i32 %3, %2
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr151, i32 noundef %add152)
  %4 = load i8*, i8** %output.addr, align 8
  %add.ptr153 = getelementptr inbounds i8, i8* %4, i64 8
  %5 = load i32, i32* %x2, align 4
  %6 = load i32, i32* %j2, align 4
  %add154 = add i32 %6, %5
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr153, i32 noundef %add154)
  %7 = load i8*, i8** %output.addr, align 8
  %add.ptr155 = getelementptr inbounds i8, i8* %7, i64 12
  %8 = load i32, i32* %x3, align 4
  %9 = load i32, i32* %j3, align 4
  %add156 = add i32 %9, %8
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr155, i32 noundef %add156)
  %10 = load i8*, i8** %output.addr, align 8
  %add.ptr157 = getelementptr inbounds i8, i8* %10, i64 16
  %11 = load i32, i32* %x4, align 4
  %12 = load i32, i32* %j4, align 4
  %add158 = add i32 %12, %11
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr157, i32 noundef %add158)
  %13 = load i8*, i8** %output.addr, align 8
  %add.ptr159 = getelementptr inbounds i8, i8* %13, i64 20
  %14 = load i32, i32* %x5, align 4
  %15 = load i32, i32* %j5, align 4
  %add160 = add i32 %15, %14
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr159, i32 noundef %add160)
  %16 = load i8*, i8** %output.addr, align 8
  %add.ptr161 = getelementptr inbounds i8, i8* %16, i64 24
  %17 = load i32, i32* %x6, align 4
  %18 = load i32, i32* %j6, align 4
  %add162 = add i32 %18, %17
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr161, i32 noundef %add162)
  %19 = load i8*, i8** %output.addr, align 8
  %add.ptr163 = getelementptr inbounds i8, i8* %19, i64 28
  %20 = load i32, i32* %x7, align 4
  %21 = load i32, i32* %j7, align 4
  %add164 = add i32 %21, %20
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr163, i32 noundef %add164)
  %22 = load i8*, i8** %output.addr, align 8
  %add.ptr165 = getelementptr inbounds i8, i8* %22, i64 32
  %23 = load i32, i32* %x8, align 4
  %24 = load i32, i32* %j8, align 4
  %add166 = add i32 %24, %23
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr165, i32 noundef %add166)
  %25 = load i8*, i8** %output.addr, align 8
  %add.ptr167 = getelementptr inbounds i8, i8* %25, i64 36
  %26 = load i32, i32* %x9, align 4
  %27 = load i32, i32* %j9, align 4
  %add168 = add i32 %27, %26
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr167, i32 noundef %add168)
  %28 = load i8*, i8** %output.addr, align 8
  %add.ptr169 = getelementptr inbounds i8, i8* %28, i64 40
  %29 = load i32, i32* %x10, align 4
  %30 = load i32, i32* %j10, align 4
  %add170 = add i32 %30, %29
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr169, i32 noundef %add170)
  %31 = load i8*, i8** %output.addr, align 8
  %add.ptr171 = getelementptr inbounds i8, i8* %31, i64 44
  %32 = load i32, i32* %x11, align 4
  %33 = load i32, i32* %j11, align 4
  %add172 = add i32 %33, %32
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr171, i32 noundef %add172)
  %34 = load i8*, i8** %output.addr, align 8
  %add.ptr173 = getelementptr inbounds i8, i8* %34, i64 48
  %35 = load i32, i32* %x12, align 4
  %36 = load i32, i32* %j12, align 4
  %add174 = add i32 %36, %35
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr173, i32 noundef %add174)
  %37 = load i8*, i8** %output.addr, align 8
  %add.ptr175 = getelementptr inbounds i8, i8* %37, i64 52
  %38 = load i32, i32* %x13, align 4
  %39 = load i32, i32* %j13, align 4
  %add176 = add i32 %39, %38
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr175, i32 noundef %add176)
  %40 = load i8*, i8** %output.addr, align 8
  %add.ptr177 = getelementptr inbounds i8, i8* %40, i64 56
  %41 = load i32, i32* %x14, align 4
  %42 = load i32, i32* %j14, align 4
  %add178 = add i32 %42, %41
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr177, i32 noundef %add178)
  %43 = load i8*, i8** %output.addr, align 8
  %add.ptr179 = getelementptr inbounds i8, i8* %43, i64 60
  %44 = load i32, i32* %x15, align 4
  %45 = load i32, i32* %j15, align 4
  %add180 = add i32 %45, %44
  call fastcc void @store32_le(i8* noundef nonnull %add.ptr179, i32 noundef %add180)
  ret void
}
...
define internal fastcc i32 @load32_le(i8* nocapture noundef readonly %src) unnamed_addr #7 {
entry:
...
define internal fastcc void @store32_le(i8* nocapture noundef writeonly %dst, i32 noundef %w) unnamed_addr #9 {
entry:
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %bindex.02 = phi i64 [ 0, %for.body.lr.ph ], [ %inc, %for.body ]
  ...
  %mul25 = shl i64 %bindex.02, 4
  %add.ptr = getelementptr inbounds i8, i8* %0, i64 %mul25
  %call = call fastcc i64 @load64_le(i8* noundef %add.ptr)
  ...
  %call30 = call fastcc i64 @load64_le(i8* noundef nonnull %add.ptr29)
  ...
  %inc = add nuw nsw i64 %bindex.02, 1
...
for.body:                                         ; preds = %if.end15, %for.body.lr.ph
  %4 = phi i64 [ %1, %for.body.lr.ph ], [ %.pre8, %if.end15 ]
  %i.04 = phi i64 [ 0, %for.body.lr.ph ], [ %inc, %if.end15 ]
  %add = add i64 %4, %i.04
...
if.end15:                                         ; preds = %if.end10
  ...
  %arrayidx = getelementptr inbounds i8, i8* %6, i64 %i.04
  ...
  %.pre8 = load i64, i64* %leftover, align 8
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !17

for.end:                                          ; preds = %if.end15, %if.then
  %9 = phi i64 [ %1, %if.then ], [ %.pre8, %if.end15 ]
...
if.end28:                                         ; preds = %if.end23, %entry
  %mindex.0 = phi i64 [ %spec.select, %if.end23 ], [ 0, %entry ]
  %len29 = getelementptr inbounds %struct.uint8ptr_wrapped_ty, %struct.uint8ptr_wrapped_ty* %m, i64 0, i32 1
  %10 = load i64, i64* %len29, align 8
  %sub30 = sub i64 %10, %mindex.0
  %cmp31 = icmp ugt i64 %sub30, 15
  br i1 %cmp31, label %if.then32, label %if.end54

if.then32:                                        ; preds = %if.end28
  %and = and i64 %sub30, -16
  %add36 = add i64 %and, %mindex.0
  %cmp37 = icmp ult i64 %mindex.0, %add36
  br i1 %cmp37, label %if.end40, label %if.else39
...
if.end46:                                         ; preds = %if.end40
  ...
  %add.ptr = getelementptr inbounds i8, i8* %11, i64 %mindex.0
  ...
  %.pre9 = load i64, i64* %len29, align 8
  br label %if.end54

if.end54:                                         ; preds = %if.end46, %if.end28
  %12 = phi i64 [ %.pre9, %if.end46 ], [ %10, %if.end28 ]
  %mindex.1 = phi i64 [ %add36, %if.end46 ], [ %mindex.0, %if.end28 ]
  %cmp56 = icmp ugt i64 %12, %mindex.1
  br i1 %cmp56, label %if.then57, label %if.end87

if.then57:                                        ; preds = %if.end54
  %sub59 = sub i64 %12, %mindex.1
  %cmp625.not = icmp eq i64 %sub59, 0
  br i1 %cmp625.not, label %for.end84, label %for.body63.lr.ph
...
for.body63:                                       ; preds = %for.body63.lr.ph, %if.end76
  %i60.06 = phi i64 [ 0, %for.body63.lr.ph ], [ %inc83, %if.end76 ]
  %14 = load i64, i64* %leftover, align 8
  %add66 = add i64 %14, %i60.06
  %cmp67 = icmp ult i64 %add66, 16
  br i1 %cmp67, label %if.end70, label %if.else69
...
if.end70:                                         ; preds = %for.body63
  %add71 = add nuw i64 %i60.06, %mindex.1
  %15 = load i64, i64* %len29, align 8
  %cmp73 = icmp ult i64 %add71, %15
  br i1 %cmp73, label %if.end76, label %if.else75
...
if.end76:                                         ; preds = %if.end70
  ...
  %inc83 = add nuw i64 %i60.06, 1
  %exitcond7.not = icmp eq i64 %inc83, %sub59
  br i1 %exitcond7.not, label %for.end84, label %for.body63, !llvm.loop !18

for.end84:                                        ; preds = %if.end76, %if.then57
...
; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local i32 @_crypto_onetimeauth_poly1305(i8* noundef %out, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %m, i8* noundef %key) #0 {
entry:
  ...
  call void @_poly1305_init(%struct.poly1305_state_internal_t* noundef nonnull %state, i8* noundef %key)
  ...
  call void @_poly1305_finish(%struct.poly1305_state_internal_t* noundef nonnull %state, i8* noundef %1)
  ret i32 0
}

; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local zeroext i1 @_crypto_onetimeauth_poly1305_verify(i8* noundef %h, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %input, i8* noundef %k) #0 {
entry:
  %k.addr = alloca i8*, align 8
  ...
  %call = call i32 @_crypto_onetimeauth_poly1305(i8* noundef nonnull %correct2, %struct.uint8ptr_wrapped_ty* noundef %input, i8* noundef %k)
  %call4 = call zeroext i1 @_crypto_verify_16(i8* noundef %h, i8* noundef nonnull %correct2)
  ret i1 %call4
}

; Function Attrs: mustprogress nofree noinline nosync nounwind sspstrong uwtable willreturn
define dso_local void @_poly1305_init(%struct.poly1305_state_internal_t* noundef %state, i8* noundef %key) local_unnamed_addr #10 {
entry:
  %key.addr = alloca i8*, align 8
  %t0 = alloca i64, align 8
  %t1 = alloca i64, align 8
  ...
  %call = call fastcc i64 @load64_le(i8* noundef %key)
  store i64 %call, i64* %t0, align 8
  ...
  %add.ptr = getelementptr inbounds i8, i8* %key, i64 8
  %call4 = call fastcc i64 @load64_le(i8* noundef nonnull %add.ptr)
  store i64 %call4, i64* %t1, align 8
  %and = and i64 %call, 17575274610687
  %0 = bitcast %struct.poly1305_state_internal_t* %state to i8*
  %1 = call i8* @llvm.ptr.annotation.p0i8(i8* %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 13, i8* null)
  %arrayidx = bitcast i8* %1 to i64*
  store i64 %and, i64* %arrayidx, align 8
  %2 = load i64, i64* %t0, align 8
  %3 = load i64, i64* %t1, align 8
  %or = call i64 @llvm.fshl.i64(i64 %3, i64 %2, i64 20)
  %and5 = and i64 %or, 17592181915647
  %4 = call i8* @llvm.ptr.annotation.p0i8(i8* %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 13, i8* null)
  %arrayidx7 = getelementptr inbounds i8, i8* %4, i64 8
  %5 = bitcast i8* %arrayidx7 to i64*
  store i64 %and5, i64* %5, align 8
  %shr8 = lshr i64 %3, 24
  %and9 = and i64 %shr8, 68719475727
  %6 = call i8* @llvm.ptr.annotation.p0i8(i8* %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 13, i8* null)
  %arrayidx11 = getelementptr inbounds i8, i8* %6, i64 16
  %7 = bitcast i8* %arrayidx11 to i64*
  store i64 %and9, i64* %7, align 8
  %h = getelementptr inbounds %struct.poly1305_state_internal_t, %struct.poly1305_state_internal_t* %state, i64 0, i32 1
  %8 = bitcast [3 x i64]* %h to i8*
  %9 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %8, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 14, i8* null)
  %arrayidx12 = bitcast i8* %9 to i64*
  store i64 0, i64* %arrayidx12, align 8
  %10 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %8, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 14, i8* null)
  %arrayidx14 = getelementptr inbounds i8, i8* %10, i64 8
  %11 = bitcast i8* %arrayidx14 to i64*
  store i64 0, i64* %11, align 8
  %12 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %8, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 14, i8* null)
  %arrayidx16 = getelementptr inbounds i8, i8* %12, i64 16
  %13 = bitcast i8* %arrayidx16 to i64*
  store i64 0, i64* %13, align 8
  %14 = load i8*, i8** %key.addr, align 8
  %add.ptr17 = getelementptr inbounds i8, i8* %14, i64 16
  %call18 = call fastcc i64 @load64_le(i8* noundef nonnull %add.ptr17)
  ...
  %arrayidx19 = bitcast i8* %16 to i64*
  store i64 %call18, i64* %arrayidx19, align 8
  %17 = load i8*, i8** %key.addr, align 8
  %add.ptr20 = getelementptr inbounds i8, i8* %17, i64 24
  %call21 = call fastcc i64 @load64_le(i8* noundef nonnull %add.ptr20)
  ...
  %arrayidx23 = getelementptr inbounds i8, i8* %18, i64 8
  %19 = bitcast i8* %arrayidx23 to i64*
  store i64 %call21, i64* %19, align 8
  %leftover = getelementptr inbounds %struct.poly1305_state_internal_t, %struct.poly1305_state_internal_t* %state, i64 0, i32 3
  store i64 0, i64* %leftover, align 8
  %final = getelementptr inbounds %struct.poly1305_state_internal_t, %struct.poly1305_state_internal_t* %state, i64 0, i32 5
  %20 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %final, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 18, i8* null)
  store i8 0, i8* %20, align 8
  ret void
}

; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local void @_poly1305_finish(%struct.poly1305_state_internal_t* noundef %state, i8* noundef %mac) local_unnamed_addr #0 {
entry:
...
if.end:                                           ; preds = %if.then
  %1 = getelementptr inbounds %struct.poly1305_state_internal_t, %struct.poly1305_state_internal_t* %state, i64 0, i32 4, i64 0
  %2 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 17, i8* null)
  %arrayidx = getelementptr inbounds i8, i8* %2, i64 %0
  store i8 1, i8* %arrayidx, align 1
  %cmp52.not = icmp eq i64 %0, 15
  br i1 %cmp52.not, label %for.end, label %for.body.preheader

for.body.preheader:                               ; preds = %if.end
  %i.01 = add nuw nsw i64 %0, 1
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.body
  %i.03 = phi i64 [ %i.0, %for.body ], [ %i.01, %for.body.preheader ]
  %3 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 17, i8* null)
  %arrayidx7 = getelementptr inbounds i8, i8* %3, i64 %i.03
  store i8 0, i8* %arrayidx7, align 1
  %i.0 = add i64 %i.03, 1
  %exitcond.not = icmp eq i64 %i.0, 16
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !19

for.end:                                          ; preds = %for.body, %if.end
  %final = getelementptr inbounds %struct.poly1305_state_internal_t, %struct.poly1305_state_internal_t* %state, i64 0, i32 5
  %4 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %final, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 18, i8* null)
...
if.end9:                                          ; preds = %for.end, %entry
  ...
  %h = getelementptr inbounds %struct.poly1305_state_internal_t, %struct.poly1305_state_internal_t* %state, i64 0, i32 1
  %5 = bitcast [3 x i64]* %h to i8*
  %6 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 14, i8* null)
  %arrayidx11 = bitcast i8* %6 to i64*
  ...
  %8 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 14, i8* null)
  %arrayidx14 = getelementptr inbounds i8, i8* %8, i64 8
  %9 = bitcast i8* %arrayidx14 to i64*
  ...
  %11 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 14, i8* null)
  %arrayidx17 = getelementptr inbounds i8, i8* %11, i64 16
  %12 = bitcast i8* %arrayidx17 to i64*
  ...
  %shr = lshr i64 %10, 44
  %and = and i64 %10, 17592186044415
  %add19 = add i64 %13, %shr
  ...
  %pad = getelementptr inbounds %struct.poly1305_state_internal_t, %struct.poly1305_state_internal_t* %state, i64 0, i32 2
  %14 = bitcast [2 x i64]* %pad to i8*
  %15 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %14, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 15, i8* null)
  %arrayidx58 = bitcast i8* %15 to i64*
  %16 = load i64, i64* %arrayidx58, align 8
  store i64 %16, i64* %t0, align 8
  ...
  %17 = call i8* @llvm.ptr.annotation.p0i8(i8* nonnull %14, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.8, i64 0, i64 0), i32 15, i8* null)
  %arrayidx61 = getelementptr inbounds i8, i8* %17, i64 8
  %18 = bitcast i8* %arrayidx61 to i64*
  %19 = load i64, i64* %18, align 8
  store i64 %19, i64* %t1, align 8
  %and62 = and i64 %16, 17592186044415
  %add63 = add nuw nsw i64 %and62, %or
  %shr64 = lshr i64 %add63, 44
  %and65 = and i64 %add63, 17592186044415
  %or67 = call i64 @llvm.fshl.i64(i64 %19, i64 %16, i64 20)
  ...
  call fastcc void @store64_le(i8* noundef %20, i64 noundef %or79)
  %21 = load i8*, i8** %mac.addr, align 8
  %add.ptr = getelementptr inbounds i8, i8* %21, i64 8
  %22 = load i64, i64* %h1, align 8
  call fastcc void @store64_le(i8* noundef nonnull %add.ptr, i64 noundef %22)
  %23 = bitcast %struct.poly1305_state_internal_t* %state to i8*
  call void @sodium_memzero(i8* noundef %23, i64 noundef 96) #14
  ret void
}
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind sspstrong uwtable willreturn writeonly
define internal fastcc void @store64_le(i8* nocapture noundef writeonly %dst, i64 noundef %w) unnamed_addr #9 {
entry:
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readonly sspstrong uwtable willreturn
define internal fastcc i64 @load64_le(i8* nocapture noundef readonly %src) unnamed_addr #7 {
entry:
  %0 = load i8, i8* %src, align 1
...
; Function Attrs: nofree noinline nosync nounwind sspstrong uwtable
define dso_local zeroext i1 @_crypto_verify_16(i8* noundef %x, i8* noundef %y) local_unnamed_addr #5 {
entry:
  ...
  %cmp6.not3 = icmp eq i8 %0, %1
  br i1 %cmp6.not3, label %for.cond, label %return

for.cond:                                         ; preds = %entry, %for.body
  %indvars.iv4 = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %entry ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv4, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 16
  br i1 %exitcond.not, label %return.loopexit, label %for.body, !llvm.loop !20

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds i8, i8* %x, i64 %indvars.iv.next
  %2 = load i8, i8* %arrayidx, align 1
  %arrayidx4 = getelementptr inbounds i8, i8* %y, i64 %indvars.iv.next
  %3 = load i8, i8* %arrayidx4, align 1
  %cmp6.not = icmp eq i8 %2, %3
  br i1 %cmp6.not, label %for.cond, label %return.loopexit, !llvm.loop !20

return.loopexit:                                  ; preds = %for.cond, %for.body
  %cmp.le = icmp ugt i64 %indvars.iv4, 14
  br label %return
...
; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local i32 @__crypto_stream_xsalsa20(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, i8* noundef %n, i8* noundef %k) #0 {
entry:
  %k.addr = alloca i8*, align 8
  ...
  %0 = getelementptr inbounds [32 x i8], [32 x i8]* %subkey, i64 0, i64 0
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %0, i8 0, i64 32, i1 false)
  call void @__crypto_core_hsalsa20(i8* noundef nonnull %0, i8* noundef %n, i8* noundef %k)
  %add.ptr = getelementptr inbounds i8, i8* %n, i64 16
  %call = call i32 @_crypto_stream_salsa20(%struct.uint8ptr_wrapped_ty* noundef %c, i8* noundef nonnull %add.ptr, i8* noundef nonnull %0)
  call void @sodium_memzero(i8* noundef nonnull %0, i64 noundef 32) #14
  ret i32 0
}

; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local i32 @__crypto_stream_xsalsa20_xor_ic(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %m, i8* noundef %n, i64 noundef %ic, i8* noundef %k) #0 {
entry:
  %k.addr = alloca i8*, align 8
  %subkey = alloca [32 x i8], align 16
  store i8* %k, i8** %k.addr, align 8
  ...
  call void @__crypto_core_hsalsa20(i8* noundef nonnull %0, i8* noundef %n, i8* noundef %k)
  %add.ptr = getelementptr inbounds i8, i8* %n, i64 16
  %call = call i32 @_crypto_stream_salsa20_xor_ic(%struct.uint8ptr_wrapped_ty* noundef %c, %struct.uint8ptr_wrapped_ty* noundef %m, i8* noundef nonnull %add.ptr, i64 noundef %ic, i8* noundef nonnull %0)
  call void @sodium_memzero(i8* noundef nonnull %0, i64 noundef 32) #14
  ret i32 0
}

; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local i32 @__crypto_stream_xsalsa20_xor(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %m, i8* noundef %n, i8* noundef %k) #0 {
entry:
  %k.addr = alloca i8*, align 8
  store i8* %k, i8** %k.addr, align 8
  %k.addr1 = bitcast i8** %k.addr to i8*
  ...
  %call = call i32 @__crypto_stream_xsalsa20_xor_ic(%struct.uint8ptr_wrapped_ty* noundef %c, %struct.uint8ptr_wrapped_ty* noundef %m, i8* noundef %n, i64 noundef 0, i8* noundef %k)
  ret i32 0
}

; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local zeroext i1 @__crypto_secretbox_xsalsa20poly1305(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %m, i8* noundef %n, i8* noundef %k) #0 {
entry:
  %k.addr = alloca i8*, align 8
  %c_buf = alloca i8*, align 8
...
if.end:                                           ; preds = %entry
  %len3 = getelementptr inbounds %struct.uint8ptr_wrapped_ty, %struct.uint8ptr_wrapped_ty* %c, i64 0, i32 1
...
if.end7:                                          ; preds = %if.end
  %call = call i32 @__crypto_stream_xsalsa20_xor(%struct.uint8ptr_wrapped_ty* noundef nonnull %c, %struct.uint8ptr_wrapped_ty* noundef nonnull %m, i8* noundef %n, i8* noundef %k)
  ...
  %3 = load i8*, i8** %c_buf, align 8
  %add.ptr = getelementptr inbounds i8, i8* %3, i64 16
  ...
  %add.ptr15 = getelementptr inbounds i8, i8* %3, i64 32
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %kview18, i8* noundef nonnull align 1 dereferenceable(32) %3, i64 32, i1 false)
  %call23 = call i32 @_crypto_onetimeauth_poly1305(i8* noundef nonnull %cview8, %struct.uint8ptr_wrapped_ty* noundef nonnull %w_mview, i8* noundef nonnull %kview18)
  %5 = load i8*, i8** %buf, align 8
  %add.ptr25 = getelementptr inbounds i8, i8* %5, i64 16
...
for.body:                                         ; preds = %if.end7, %for.body
  %i.01 = phi i64 [ 0, %if.end7 ], [ %inc, %for.body ]
  %6 = load i8*, i8** %buf, align 8
  %arrayidx = getelementptr inbounds i8, i8* %6, i64 %i.01
  store i8 0, i8* %arrayidx, align 1
  %inc = add nuw nsw i64 %i.01, 1
...
; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local zeroext i1 @__crypto_secretbox_xsalsa20poly1305_open(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %m, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, i8* noundef %n, i8* noundef %k) #0 {
entry:
  %k.addr = alloca i8*, align 8
  %c_buf = alloca i8*, align 8
...
if.end7:                                          ; preds = %if.end
  ...
  %call11 = call i32 @__crypto_stream_xsalsa20(%struct.uint8ptr_wrapped_ty* noundef nonnull %w_subkey, i8* noundef %n, i8* noundef %k)
  ...
  %5 = load i8*, i8** %buf, align 8
  %add.ptr22 = getelementptr inbounds i8, i8* %5, i64 32
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %call18, i8* nonnull align 1 %add.ptr22, i64 %sub, i1 false)
  %call26 = call zeroext i1 @_crypto_onetimeauth_poly1305_verify(i8* noundef nonnull %arraydecay14, %struct.uint8ptr_wrapped_ty* noundef nonnull %w_cview, i8* noundef nonnull %subkey12)
  br i1 %call26, label %if.end28, label %return

if.end28:                                         ; preds = %if.end7
  %6 = load i8*, i8** %k.addr, align 8
  %call29 = call i32 @__crypto_stream_xsalsa20_xor(%struct.uint8ptr_wrapped_ty* noundef nonnull %m, %struct.uint8ptr_wrapped_ty* noundef nonnull %c, i8* noundef %n, i8* noundef %6)
...
for.body:                                         ; preds = %if.end28, %for.body
  %indvars.iv = phi i64 [ 0, %if.end28 ], [ %indvars.iv.next, %for.body ]
...
return:                                           ; preds = %for.body, %if.end7, %entry
  %retval.0 = phi i1 [ false, %entry ], [ false, %if.end7 ], [ true, %for.body ]
  ret i1 %retval.0
}

; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local zeroext i1 @__crypto_secretbox(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %m, i8* noundef %n, i8* noundef %k) #0 {
entry:
  %k.addr = alloca i8*, align 8
  store i8* %k, i8** %k.addr, align 8
  %k.addr1 = bitcast i8** %k.addr to i8*
  ...
  %call = call zeroext i1 @__crypto_secretbox_xsalsa20poly1305(%struct.uint8ptr_wrapped_ty* noundef %c, %struct.uint8ptr_wrapped_ty* noundef %m, i8* noundef %n, i8* noundef %k)
  ret i1 %call
}

; Function Attrs: noinline nounwind sspstrong uwtable
define dso_local zeroext i1 @__crypto_secretbox_open(%struct.uint8ptr_wrapped_ty* nocapture noundef readonly %m, %struct.uint8ptr_wrapped_ty* nocapture noundef readonly %c, i8* noundef %n, i8* noundef %k) #0 {
entry:
  %k.addr = alloca i8*, align 8
  store i8* %k, i8** %k.addr, align 8
  %k.addr1 = bitcast i8** %k.addr to i8*
  ...
  %call = call zeroext i1 @__crypto_secretbox_xsalsa20poly1305_open(%struct.uint8ptr_wrapped_ty* noundef %m, %struct.uint8ptr_wrapped_ty* noundef %c, i8* noundef %n, i8* noundef %k)
  ret i1 %call
}
...
; Function Attrs: nofree noinline nosync nounwind sspstrong uwtable
define dso_local void @__crypto_core_hsalsa20(i8* noundef %out, i8* noundef %input, i8* noundef %k) local_unnamed_addr #5 {
entry:
  %out.addr = alloca i8*, align 8
  %input.addr = alloca i8*, align 8
  %k.addr = alloca i8*, align 8
  ...
  %call = call fastcc i32 @load32_le.22(i8* noundef %k)
  %add.ptr = getelementptr inbounds i8, i8* %k, i64 4
  %call4 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr)
  %add.ptr5 = getelementptr inbounds i8, i8* %k, i64 8
  %call6 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr5)
  %add.ptr7 = getelementptr inbounds i8, i8* %k, i64 12
  %call8 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr7)
  %add.ptr9 = getelementptr inbounds i8, i8* %k, i64 16
  %call10 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr9)
  %add.ptr11 = getelementptr inbounds i8, i8* %k, i64 20
  %call12 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr11)
  %add.ptr13 = getelementptr inbounds i8, i8* %k, i64 24
  %call14 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr13)
  %add.ptr15 = getelementptr inbounds i8, i8* %k, i64 28
  %call16 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr15)
  %call17 = call fastcc i32 @load32_le.22(i8* noundef %input)
  %add.ptr18 = getelementptr inbounds i8, i8* %input, i64 4
  %call19 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr18)
  %add.ptr20 = getelementptr inbounds i8, i8* %input, i64 8
  %call21 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr20)
  %add.ptr22 = getelementptr inbounds i8, i8* %input, i64 12
  %call23 = call fastcc i32 @load32_le.22(i8* noundef nonnull %add.ptr22)
  br label %for.body

for.body:                                         ; preds = %entry, %for.body
  %x0.017 = phi i32 [ 1634760805, %entry ], [ %xor80, %for.body ]
  %x5.016 = phi i32 [ 857760878, %entry ], [ %xor92, %for.body ]
  %x10.015 = phi i32 [ 2036477234, %entry ], [ %xor104, %for.body ]
  %x15.014 = phi i32 [ 1797285236, %entry ], [ %xor116, %for.body ]
  %x1.013 = phi i32 [ %call, %entry ], [ %xor71, %for.body ]
  %x2.012 = phi i32 [ %call4, %entry ], [ %xor74, %for.body ]
  %x3.011 = phi i32 [ %call6, %entry ], [ %xor77, %for.body ]
  %x4.010 = phi i32 [ %call8, %entry ], [ %xor89, %for.body ]
  %x11.09 = phi i32 [ %call10, %entry ], [ %xor95, %for.body ]
  %x12.08 = phi i32 [ %call12, %entry ], [ %xor107, %for.body ]
  %x13.07 = phi i32 [ %call14, %entry ], [ %xor110, %for.body ]
  %x14.06 = phi i32 [ %call16, %entry ], [ %xor113, %for.body ]
  %x6.05 = phi i32 [ %call17, %entry ], [ %xor83, %for.body ]
  %x7.04 = phi i32 [ %call19, %entry ], [ %xor86, %for.body ]
  %x8.03 = phi i32 [ %call21, %entry ], [ %xor98, %for.body ]
  %x9.02 = phi i32 [ %call23, %entry ], [ %xor101, %for.body ]
  %i.01 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  %add = add i32 %x0.017, %x12.08
  %shl = shl i32 %add, 7
  %xor = xor i32 %shl, %x4.010
  %add24 = add i32 %xor, %x0.017
  %shl25 = shl i32 %add24, 9
  %xor26 = xor i32 %shl25, %x8.03
  %add27 = add i32 %xor26, %xor
  %shl28 = shl i32 %add27, 13
  %xor29 = xor i32 %shl28, %x12.08
  %add30 = add i32 %xor29, %xor26
  %shl31 = shl i32 %add30, 18
  %xor32 = xor i32 %shl31, %x0.017
  %add33 = add i32 %x5.016, %x1.013
  %shl34 = shl i32 %add33, 7
  %xor35 = xor i32 %shl34, %x9.02
  %add36 = add i32 %xor35, %x5.016
  %shl37 = shl i32 %add36, 9
  %xor38 = xor i32 %shl37, %x13.07
  %add39 = add i32 %xor38, %xor35
  %shl40 = shl i32 %add39, 13
  %xor41 = xor i32 %shl40, %x1.013
  %add42 = add i32 %xor41, %xor38
  %shl43 = shl i32 %add42, 18
  %xor44 = xor i32 %shl43, %x5.016
  %add45 = add i32 %x10.015, %x6.05
  %shl46 = shl i32 %add45, 7
  %xor47 = xor i32 %shl46, %x14.06
  %add48 = add i32 %xor47, %x10.015
  %shl49 = shl i32 %add48, 9
  %xor50 = xor i32 %shl49, %x2.012
  %add51 = add i32 %xor50, %xor47
  %shl52 = shl i32 %add51, 13
  %xor53 = xor i32 %shl52, %x6.05
  %add54 = add i32 %xor53, %xor50
  %shl55 = shl i32 %add54, 18
  %xor56 = xor i32 %shl55, %x10.015
  %add57 = add i32 %x15.014, %x11.09
  %shl58 = shl i32 %add57, 7
  %xor59 = xor i32 %shl58, %x3.011
  %add60 = add i32 %xor59, %x15.014
  %shl61 = shl i32 %add60, 9
  %xor62 = xor i32 %shl61, %x7.04
  %add63 = add i32 %xor62, %xor59
  %shl64 = shl i32 %add63, 13
  %xor65 = xor i32 %shl64, %x11.09
  %add66 = add i32 %xor65, %xor62
  %shl67 = shl i32 %add66, 18
  %xor68 = xor i32 %shl67, %x15.014
...
for.end:                                          ; preds = %for.body
  call fastcc void @store32_le.23(i8* noundef %out, i32 noundef %xor80)
  %0 = load i8*, i8** %out.addr, align 8
  %add.ptr117 = getelementptr inbounds i8, i8* %0, i64 4
  call fastcc void @store32_le.23(i8* noundef nonnull %add.ptr117, i32 noundef %xor92)
  %1 = load i8*, i8** %out.addr, align 8
  %add.ptr118 = getelementptr inbounds i8, i8* %1, i64 8
  call fastcc void @store32_le.23(i8* noundef nonnull %add.ptr118, i32 noundef %xor104)
  %2 = load i8*, i8** %out.addr, align 8
  %add.ptr119 = getelementptr inbounds i8, i8* %2, i64 12
  call fastcc void @store32_le.23(i8* noundef nonnull %add.ptr119, i32 noundef %xor116)
  %3 = load i8*, i8** %out.addr, align 8
  %add.ptr120 = getelementptr inbounds i8, i8* %3, i64 16
  call fastcc void @store32_le.23(i8* noundef nonnull %add.ptr120, i32 noundef %xor83)
  %4 = load i8*, i8** %out.addr, align 8
  %add.ptr121 = getelementptr inbounds i8, i8* %4, i64 20
  call fastcc void @store32_le.23(i8* noundef nonnull %add.ptr121, i32 noundef %xor86)
  %5 = load i8*, i8** %out.addr, align 8
  %add.ptr122 = getelementptr inbounds i8, i8* %5, i64 24
  call fastcc void @store32_le.23(i8* noundef nonnull %add.ptr122, i32 noundef %xor98)
  %6 = load i8*, i8** %out.addr, align 8
  %add.ptr123 = getelementptr inbounds i8, i8* %6, i64 28
  call fastcc void @store32_le.23(i8* noundef nonnull %add.ptr123, i32 noundef %xor101)
  ret void
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind readonly sspstrong uwtable willreturn
define internal fastcc i32 @load32_le.22(i8* nocapture noundef readonly %src) unnamed_addr #7 {
entry:
  %0 = load i8, i8* %src, align 1
  %conv = zext i8 %0 to i32
  %arrayidx1 = getelementptr inbounds i8, i8* %src, i64 1
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind sspstrong uwtable willreturn writeonly
define internal fastcc void @store32_le.23(i8* nocapture noundef writeonly %dst, i32 noundef %w) unnamed_addr #9 {
entry:
  %conv = trunc i32 %w to i8
  store i8 %conv, i8* %dst, align 1
  %shr = lshr i32 %w, 8
...
entry:
  ...
  %1 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* nonnull %arrayidx, i64 0) #14, !srcloc !24
  ...
  %3 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* nonnull %arrayidx26, i64 0) #14, !srcloc !25
  ...
  %5 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* nonnull %arrayidx39, i64 0) #14, !srcloc !26
  ...
  %call50 = call zeroext i1 @__crypto_secretbox(%struct.uint8ptr_wrapped_ty* noundef nonnull %c, %struct.uint8ptr_wrapped_ty* noundef nonnull %m, i8* noundef nonnull %arraydecay, i8* noundef nonnull %arraydecay13)
  %frombool = zext i1 %call50 to i8
  store i8 %frombool, i8* %r1, align 1
  %call53 = call zeroext i1 @__crypto_secretbox_open(%struct.uint8ptr_wrapped_ty* noundef nonnull %m, %struct.uint8ptr_wrapped_ty* noundef nonnull %c, i8* noundef nonnull %arraydecay, i8* noundef nonnull %arraydecay13)
...
attributes #9 = { mustprogress nofree noinline norecurse nosync nounwind sspstrong uwtable willreturn writeonly "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!22 = distinct !{!22, !7}
!23 = distinct !{!23, !7}
!24 = !{i64 2148412567, i64 2148412603, i64 2148412671}
!25 = !{i64 2148414202, i64 2148414238, i64 2148414306}
!26 = !{i64 2148415798, i64 2148415834, i64 2148415902}
