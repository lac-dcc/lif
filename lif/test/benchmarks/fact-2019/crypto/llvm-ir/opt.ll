...
entry:
  ...
  %call17 = call zeroext i1 @__crypto_secretbox(%struct.uint8ptr_wrapped_ty* noundef nonnull %c, %struct.uint8ptr_wrapped_ty* noundef nonnull %m, i8* noundef nonnull %arraydecay, i8* noundef nonnull %arraydecay13)
  %frombool = zext i1 %call17 to i8
  store i8 %frombool, i8* %r1, align 1
  %call20 = call zeroext i1 @__crypto_secretbox_open(%struct.uint8ptr_wrapped_ty* noundef nonnull %m, %struct.uint8ptr_wrapped_ty* noundef nonnull %c, i8* noundef nonnull %arraydecay, i8* noundef nonnull %arraydecay13)
