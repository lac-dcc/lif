...
if.end9:                                          ; preds = %for.end, %entry
  ...
  call void @sodium_memzero(i8* noundef %23, i64 noundef 96) #16
  ret void
}
...
entry:
  ...
  call void @sodium_memzero(i8* noundef nonnull %0, i64 noundef 32) #16
  ret i32 0
}
...
entry:
  ...
  %call18 = call zeroext i1 @__crypto_secretbox(%struct.uint8ptr_wrapped_ty* noundef nonnull %c, %struct.uint8ptr_wrapped_ty* noundef nonnull %m, i8* noundef nonnull %arraydecay, i8* noundef nonnull %arraydecay13)
  %frombool = zext i1 %call18 to i8
  store i8 %frombool, i8* %r1, align 1
  %call21 = call zeroext i1 @__crypto_secretbox_open(%struct.uint8ptr_wrapped_ty* noundef nonnull %m, %struct.uint8ptr_wrapped_ty* noundef nonnull %c, i8* noundef nonnull %arraydecay, i8* noundef nonnull %arraydecay13)
