...
entry:
  ...
  %x.unwrapped.unwrapped22 = getelementptr inbounds %i64ptr.wrapped.ty, %i64ptr.wrapped.ty* %x.unwrapped.wrapped21, i64 0, i32 0
  %x.unwrapped.wrapped21.field0.length.ptr = getelementptr inbounds %i64ptr.wrapped.ty, %i64ptr.wrapped.ty* %x.unwrapped.wrapped21, i64 0, i32 1
  ...
  call void @fsum(%i64ptr.wrapped.ty* nonnull %x.unwrapped.wrapped21, %i64ptr.wrapped.ty* nonnull %z.unwrapped.wrapped23)
  ...
  call void @fsum(%i64ptr.wrapped.ty* nonnull %xprime.unwrapped.wrapped17, %i64ptr.wrapped.ty* nonnull %zprime.unwrapped.wrapped19)
  ...
  call void @fmul(%i64ptr.wrapped.ty* nonnull %arraydecay4.wrapped, %i64ptr.wrapped.ty* nonnull %xprime.unwrapped.wrapped, %i64ptr.wrapped.ty* nonnull %z.unwrapped.wrapped15)
  ...
  %x.unwrapped.unwrapped12 = getelementptr inbounds %i64ptr.wrapped.ty, %i64ptr.wrapped.ty* %x.unwrapped.wrapped11, i64 0, i32 0
  %x.unwrapped.wrapped11.field0.length.ptr = getelementptr inbounds %i64ptr.wrapped.ty, %i64ptr.wrapped.ty* %x.unwrapped.wrapped11, i64 0, i32 1
  ...
  %zprime.unwrapped.unwrapped14 = getelementptr inbounds %i64ptr.wrapped.ty, %i64ptr.wrapped.ty* %zprime.unwrapped.wrapped13, i64 0, i32 0
  %zprime.unwrapped.wrapped13.field0.length.ptr = getelementptr inbounds %i64ptr.wrapped.ty, %i64ptr.wrapped.ty* %zprime.unwrapped.wrapped13, i64 0, i32 1
  ...
  call void @fmul(%i64ptr.wrapped.ty* nonnull %arraydecay5.wrapped, %i64ptr.wrapped.ty* nonnull %x.unwrapped.wrapped11, %i64ptr.wrapped.ty* nonnull %zprime.unwrapped.wrapped13)
...
entry:
  ...
  %1 = getelementptr inbounds [32 x i8], [32 x i8]* %basepoint, i64 0, i64 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %1, i8* noundef nonnull align 16 dereferenceable(32) getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const.main.basepoint, i64 0, i32 0), i64 32, i1 false)
  %arraydecay2.unwrapped = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay2.wrapped, i64 0, i32 0
  %arraydecay2.wrapped.field0.length.ptr = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay2.wrapped, i64 0, i32 1
  store i64 32, i64* %arraydecay2.wrapped.field0.length.ptr, align 8
  store i8* %0, i8** %arraydecay2.unwrapped, align 8
  %arraydecay3.unwrapped = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay3.wrapped, i64 0, i32 0
  %arraydecay3.wrapped.field0.length.ptr = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay3.wrapped, i64 0, i32 1
  store i64 32, i64* %arraydecay3.wrapped.field0.length.ptr, align 8
  store i8* %data1, i8** %arraydecay3.unwrapped, align 8
  %arraydecay4.unwrapped = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay4.wrapped, i64 0, i32 0
  %arraydecay4.wrapped.field0.length.ptr = getelementptr inbounds %i8ptr.wrapped.ty, %i8ptr.wrapped.ty* %arraydecay4.wrapped, i64 0, i32 1
  store i64 32, i64* %arraydecay4.wrapped.field0.length.ptr, align 8
  store i8* %1, i8** %arraydecay4.unwrapped, align 8
  %call5 = call i32 @curve25519_donna(%i8ptr.wrapped.ty* nonnull %arraydecay2.wrapped, %i8ptr.wrapped.ty* nonnull %arraydecay3.wrapped, %i8ptr.wrapped.ty* nonnull %arraydecay4.wrapped)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %data1, i8* noundef nonnull align 16 dereferenceable(32) %0, i64 32, i1 false)
  %2 = load i8, i8* %0, align 16
  store i8 %2, i8* %ret, align 1
  %call10 = call i64 @write(i32 noundef 1, i8* noundef nonnull %ret, i64 noundef 1) #10
  ret i32 0
}
...
attributes #8 = { nofree noinline nounwind sspstrong uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
