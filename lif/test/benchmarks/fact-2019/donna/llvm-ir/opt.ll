...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %0, i8* noundef nonnull align 16 dereferenceable(32) getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const.main.basepoint, i64 0, i32 0), i64 32, i1 false)
  %call5 = call i32 @curve25519_donna(i8* undef, i8* noundef nonnull %data1, i8* noundef nonnull %0)
  ...
  %call10 = call i64 @write(i32 noundef 1, i8* noundef nonnull %ret, i64 noundef 1) #11
  ret i32 0
}
...
attributes #9 = { nofree noinline nounwind sspstrong uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
