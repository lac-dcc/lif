...
for.end:                                          ; preds = %for.body
  ...
  %0 = ptrtoint [4 x i8]* %vla24 to i64
  ...
  %1 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* nonnull %arrayidx7, i64 0) #5, !srcloc !17
  ...
  %3 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* nonnull %arrayidx16, i64 0) #5, !srcloc !18
  store volatile i64 %3, i64* %_zzq_result15, align 8
  %_zzq_result15.0._zzq_result15.0._zzq_result15.0. = load volatile i64, i64* %_zzq_result15, align 8
...
for.body26:                                       ; preds = %for.end, %for.body26
  %indvars.iv8 = phi i64 [ 0, %for.end ], [ %indvars.iv.next9, %for.body26 ]
  %arrayidx28 = getelementptr inbounds [3 x i8*], [3 x i8*]* %vla3, i64 0, i64 %indvars.iv8
  %4 = load i8*, i8** %arrayidx28, align 8
  %call29 = call i64 @write(i32 noundef 1, i8* noundef %4, i64 noundef 10) #5
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1
  %exitcond11.not = icmp eq i64 %indvars.iv.next9, 3
  br i1 %exitcond11.not, label %for.end32, label %for.body26, !llvm.loop !19
...
!15 = distinct !{!15, !7}
!16 = distinct !{!16, !7}
!17 = !{i64 2148240186, i64 2148240222, i64 2148240290}
!18 = !{i64 2148241812, i64 2148241848, i64 2148241916}
!19 = distinct !{!19, !7}
