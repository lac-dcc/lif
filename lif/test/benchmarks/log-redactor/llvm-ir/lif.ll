...
for.inc48:                                        ; preds = %for.end47
  ...
  %cond.fold78 = or i1 false, %87
  %cond.fold79 = or i1 %cond.fold78, %86
...
for.cond7:                                        ; preds = %for.inc13, %for.end
  %j.0.rewritten = phi i32 [ 0, %for.end ], [ %inc14, %for.inc13 ]
  %fwedge.taken1.rewritten = phi i1 [ true, %for.end ], [ false, %for.inc13 ]
  %exitpred.frozen2.rewritten = phi i1 [ %cmp8, %for.inc13 ], [ false, %for.end ]
  %8 = load i1, i1* %out.9, align 1
  %9 = load i1, i1* %out.6, align 1
  %fwcond.and.fwtaken15 = and i1 %fwedge.taken1.rewritten, %9
  %cond.fold16 = or i1 %fwcond.and.fwtaken15, %8
  store i1 %cond.fold16, i1* %out.7, align 1
  %cmp8 = icmp ult i32 %j.0.rewritten, 3
  br i1 %cmp8, label %for.body9, label %for.end15

for.body9:                                        ; preds = %for.cond7
  %10 = load i1, i1* %out.7, align 1
  %in.17 = and i1 %10, %cmp8
  %cond.fold18 = or i1 false, %in.17
  store i1 %cond.fold18, i1* %out.8, align 1
  %idxprom10 = zext i32 %j.0.rewritten to i64
  %arrayidx11 = getelementptr inbounds i8*, i8** %vla, i64 %idxprom10
  %11 = load i8*, i8** %arrayidx11, align 8
  %call12 = call i64 @write(i32 noundef 1, i8* noundef %11, i64 noundef 10)
  br label %for.inc13
...
for.inc13:                                        ; preds = %for.body9
  ...
  %inc14 = add i32 %j.0.rewritten, 1
  br label %for.cond7, !llvm.loop !12

for.end15:                                        ; preds = %for.cond7
  %13 = load i1, i1* %out.7, align 1
  %14 = xor i1 %cmp8, true
  %in.20 = and i1 %13, %14
