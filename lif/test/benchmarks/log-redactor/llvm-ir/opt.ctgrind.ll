...
for.end:                                          ; preds = %for.body
  ...
  %1 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* nonnull %arrayidx7, i64 0) #5, !srcloc !12
  ...
  %3 = call i64 asm sideeffect "rolq $$3,  %rdi ; rolq $$13, %rdi\0A\09rolq $$61, %rdi ; rolq $$51, %rdi\0A\09xchgq %rbx,%rbx", "={dx},{ax},0,~{cc},~{memory},~{dirflag},~{fpsr},~{flags}"(i64* nonnull %arrayidx16, i64 0) #5, !srcloc !13
...
for.body26:                                       ; preds = %for.end, %for.body26
  ...
  br i1 %exitcond11.not, label %for.end32, label %for.body26, !llvm.loop !14
