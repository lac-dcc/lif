...
entry:
  ...
  store i64 3, i64* %arraydecay2.wrapped.field0.length.ptr, align 8
  store i32* %arraydecay, i32** %arraydecay2.unwrapped, align 8
  call void @mu(%i32ptr.wrapped.ty* nonnull %arraydecay2.wrapped)
